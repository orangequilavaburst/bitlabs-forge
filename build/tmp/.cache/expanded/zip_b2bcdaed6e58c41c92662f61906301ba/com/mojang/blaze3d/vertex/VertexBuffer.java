...
public class VertexBuffer implements AutoCloseable {
   ...
   private VertexFormat uploadVertexBuffer(BufferBuilder.DrawState p_231219_, @Nullable ByteBuffer p_231220_) {
      boolean flag = false;
   ...
   @Nullable
   private RenderSystem.AutoStorageIndexBuffer uploadIndexBuffer(BufferBuilder.DrawState p_231224_, @Nullable ByteBuffer p_231225_) {
      if (p_231225_ != null) {
