...
public class GetServerDetailsTask extends LongRunningTask {
   ...
   private static UUID generatePackId(RealmsServer p_311215_) {
      return p_311215_.minigameName != null ? UUID.nameUUIDFromBytes(("minigame:" + p_311215_.minigameName).getBytes(StandardCharsets.UTF_8)) : UUID.nameUUIDFromBytes(("realms:" + p_311215_.name + ":" + p_311215_.activeSlot).getBytes(StandardCharsets.UTF_8));
   }
   ...
   private RealmsLongConfirmationScreen resourcePackDownloadConfirmationScreen(RealmsServerAddress p_167640_, UUID p_309510_, Function<RealmsServerAddress, Screen> p_167641_) {
      BooleanConsumer booleanconsumer = (p_167645_) -> {
         if (!p_167645_) {
            ...
            this.scheduleResourcePackDownload(p_167640_, p_309510_).thenRun(() -> {
