...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   void op(int p_89193_) {
      ...
      UUID uuid = this.serverData.players.get(p_89193_).getUuid();
   ...
   void deop(int p_89195_) {
      RealmsClient realmsclient = RealmsClient.create();
      UUID uuid = this.serverData.players.get(p_89195_).getUuid();
   ...
   public void render(GuiGraphics p_281762_, int p_282648_, int p_282676_, float p_281822_) {
      ...
      p_281762_.drawCenteredString(this.font, this.title, this.width / 2, 17, -1);
      int i = row(12) + 20;
      ...
      p_281762_.drawString(this.font, Component.translatable("mco.configure.world.invited.number", s), this.column1X, row(0), -1, false);
   }
