...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   class BackupInfoList extends ObjectSelectionList<RealmsBackupInfoScreen.BackupInfoListEntry> {
      public BackupInfoList(Minecraft p_88082_) {
         super(p_88082_, RealmsBackupInfoScreen.this.width, RealmsBackupInfoScreen.this.height - RealmsBackupInfoScreen.this.layout.getFooterHeight() - RealmsBackupInfoScreen.this.layout.getHeaderHeight(), RealmsBackupInfoScreen.this.layout.getHeaderHeight(), 36);
