...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   private void createExperimentsButton(LinearLayout p_310633_) {
      PackRepository packrepository = ServerPacksSource.createVanillaTrustedRepository();
      packrepository.reload();
      p_310633_.addChild(Button.builder(Component.translatable("selectWorld.experiments"), (p_308065_) -> {
         this.minecraft.setScreen(new ExperimentsScreen(this, packrepository, (p_308063_) -> {
            this.experiments.clear();

            for(Pack pack : p_308063_.getSelectedPacks()) {
