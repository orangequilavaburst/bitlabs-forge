...
public class RealmsServer extends ValueObject {
   ...
   public void updateServerPing(RealmsServerPlayerList p_87507_) {
      ...
      for(UUID uuid : p_87507_.players) {
   ...
   public static RealmsServer parse(JsonObject p_87500_) {
      ...
      try {
         ...
         realmsserver.parentWorldId = JsonUtils.getLongOr("parentWorldId", p_87500_, -1L);
         realmsserver.parentWorldName = JsonUtils.getStringOr("parentWorldName", p_87500_, (String)null);
