...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void render(GuiGraphics p_283405_, int p_282020_, int p_282404_, float p_281280_) {
      ...
      p_283405_.drawCenteredString(this.font, this.title, this.width / 2, 12, -1);
      if (this.noBackups) {
         p_283405_.drawString(this.font, NO_BACKUPS_LABEL, 20, this.height / 2 - 10, -1, false);
      }
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsBackupScreen.Entry> {
      ...
      private static final WidgetSprites CHANGES_BUTTON_SPRITES = new WidgetSprites(new ResourceLocation("backup/changes"), new ResourceLocation("backup/changes_highlighted"));
      private static final WidgetSprites RESTORE_BUTTON_SPRITES = new WidgetSprites(new ResourceLocation("backup/restore"), new ResourceLocation("backup/restore_highlighted"));
      ...
      private void addChangesButton() {
         ...
         this.changesButton = new ImageButton(k, l, 9, 9, CHANGES_BUTTON_SPRITES, (p_279278_) -> {
      ...
      private void addRestoreButton() {
         ...
         int l = RealmsBackupScreen.this.backupObjectSelectionList.getRowTop(RealmsBackupScreen.this.backups.indexOf(this.backup)) + 2;
         this.restoreButton = new ImageButton(k, l, 17, 10, RESTORE_BUTTON_SPRITES, (p_279191_) -> {
