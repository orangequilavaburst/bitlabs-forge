...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   private RealmsResetWorldScreen(Screen p_89329_, RealmsServer p_89330_, int p_299248_, Component p_299051_, Component p_300553_, int p_300846_, Component p_298233_, Runnable p_89331_) {
      this(p_89329_, p_89330_, p_299248_, p_299051_, p_300553_, p_300846_, p_298233_, (WorldCreationTask)null, p_89331_);
   }

   public RealmsResetWorldScreen(Screen p_310390_, RealmsServer p_311752_, int p_312610_, Component p_310665_, Component p_312883_, int p_311717_, Component p_309644_, @Nullable WorldCreationTask p_309833_, Runnable p_311131_) {
      super(p_310665_);
      ...
      this.worldCreationTask = p_309833_;
      this.resetWorldRunnable = p_311131_;
   }

   public static RealmsResetWorldScreen forNewRealm(Screen p_300926_, RealmsServer p_297918_, WorldCreationTask p_312539_, Runnable p_299910_) {
      return new RealmsResetWorldScreen(p_300926_, p_297918_, p_297918_.activeSlot, CREATE_REALM_TITLE, CREATE_REALM_SUBTITLE, -6250336, CREATE_WORLD_RESET_TASK_TITLE, p_312539_, p_299910_);
   }
   ...
   public void switchSlot(Runnable p_89383_) {
      this.minecraft.setScreen(new RealmsLongRunningMcoTaskScreen(this.lastScreen, new SwitchSlotTask(this.serverData.id, this.slot, () -> {
