...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.trailerButton = linearlayout.addChild(Button.builder(TRAILER_BUTTON_NAME, (p_89701_) -> {
         this.onTrailer();
      }).width(100).build());
      this.selectButton = linearlayout.addChild(Button.builder(SELECT_BUTTON_NAME, (p_89696_) -> {
         this.selectTemplate();
      }).width(100).build());
      linearlayout.addChild(Button.builder(CommonComponents.GUI_CANCEL, (p_89691_) -> {
         this.onClose();
      }).width(100).build());
      this.publisherButton = linearlayout.addChild(Button.builder(PUBLISHER_BUTTON_NAME, (p_89679_) -> {
         this.onPublish();
      }).width(100).build());
      this.updateButtonStates();
      this.layout.visitWidgets((p_296088_) -> {
         AbstractWidget abstractwidget = this.addRenderableWidget(p_296088_);
      });
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsSelectWorldTemplateScreen.Entry> {
      ...
      public Entry(WorldTemplate p_89753_) {
         ...
         if (!p_89753_.link.isBlank()) {
            this.websiteButton = new ImageButton(15, 15, WEBSITE_LINK_SPRITES, ConfirmLinkScreen.confirmLink(RealmsSelectWorldTemplateScreen.this, p_89753_.link), PUBLISHER_LINK_TOOLTIP);
            this.websiteButton.setTooltip(Tooltip.create(PUBLISHER_LINK_TOOLTIP));
         }

         if (!p_89753_.trailer.isBlank()) {
            this.trailerButton = new ImageButton(15, 15, TRAILER_LINK_SPRITES, ConfirmLinkScreen.confirmLink(RealmsSelectWorldTemplateScreen.this, p_89753_.trailer), TRAILER_LINK_TOOLTIP);
      ...
      public void render(GuiGraphics p_281796_, int p_282160_, int p_281759_, int p_282961_, int p_281497_, int p_282427_, int p_283550_, int p_282955_, boolean p_282866_, float p_281452_) {
         p_281796_.blit(RealmsTextureManager.worldTemplate(this.template.id, this.template.image), p_282961_ + 1, p_281759_ + 1 + 1, 0.0F, 0.0F, 38, 38, 38, 38);
   ...
   class WorldTemplateList extends RealmsObjectSelectionList<RealmsSelectWorldTemplateScreen.Entry> {
      ...
      public WorldTemplateList(Iterable<WorldTemplate> p_89795_) {
         super(RealmsSelectWorldTemplateScreen.this.width, RealmsSelectWorldTemplateScreen.this.height - 36 - RealmsSelectWorldTemplateScreen.this.getHeaderHeight(), RealmsSelectWorldTemplateScreen.this.getHeaderHeight(), 46);
