...
public class ScoreboardSlotArgument implements ArgumentType<DisplaySlot> {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType((p_308385_) -> {
      return Component.translatableEscape("argument.scoreboardDisplaySlot.invalid", p_308385_);
   });
