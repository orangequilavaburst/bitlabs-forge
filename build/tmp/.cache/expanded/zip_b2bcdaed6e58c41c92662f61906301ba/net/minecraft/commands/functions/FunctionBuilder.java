...
class FunctionBuilder<T extends ExecutionCommandSource<T>> {
   ...
   public void addMacro(String p_312905_, int p_310777_) {
   ...
   public CommandFunction<T> build(ResourceLocation p_311383_) {
      return (CommandFunction<T>)(this.macroEntries != null ? new MacroFunction<>(p_311383_, this.macroEntries, this.macroArguments) : new PlainTextFunction<>(p_311383_, this.plainEntries));
   }
}