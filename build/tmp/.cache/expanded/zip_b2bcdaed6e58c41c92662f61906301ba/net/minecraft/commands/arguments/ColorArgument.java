...
public class ColorArgument implements ArgumentType<ChatFormatting> {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType((p_308345_) -> {
      return Component.translatableEscape("argument.color.invalid", p_308345_);
   });
