...
public class ResourceOrTagArgument<T> implements ArgumentType<ResourceOrTagArgument.Result<T>> {
   ...
   private static final Dynamic2CommandExceptionType ERROR_UNKNOWN_TAG = new Dynamic2CommandExceptionType((p_308372_, p_308373_) -> {
      return Component.translatableEscape("argument.resource_tag.not_found", p_308372_, p_308373_);
   });
   private static final Dynamic3CommandExceptionType ERROR_INVALID_TAG_TYPE = new Dynamic3CommandExceptionType((p_308374_, p_308375_, p_308376_) -> {
      return Component.translatableEscape("argument.resource_tag.invalid_type", p_308374_, p_308375_, p_308376_);
   });
