...
public class DimensionArgument implements ArgumentType<ResourceLocation> {
   ...
   private static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType((p_308347_) -> {
      return Component.translatableEscape("argument.dimension.invalid", p_308347_);
   });
