...
public class ResourceArgument<T> implements ArgumentType<Holder.Reference<T>> {
   ...
   private static final DynamicCommandExceptionType ERROR_NOT_SUMMONABLE_ENTITY = new DynamicCommandExceptionType((p_308361_) -> {
      return Component.translatableEscape("entity.not_summonable", p_308361_);
   });
   public static final Dynamic2CommandExceptionType ERROR_UNKNOWN_RESOURCE = new Dynamic2CommandExceptionType((p_308359_, p_308360_) -> {
      return Component.translatableEscape("argument.resource.not_found", p_308359_, p_308360_);
   });
   public static final Dynamic3CommandExceptionType ERROR_INVALID_RESOURCE_TYPE = new Dynamic3CommandExceptionType((p_308362_, p_308363_, p_308364_) -> {
      return Component.translatableEscape("argument.resource.invalid_type", p_308362_, p_308363_, p_308364_);
   });
