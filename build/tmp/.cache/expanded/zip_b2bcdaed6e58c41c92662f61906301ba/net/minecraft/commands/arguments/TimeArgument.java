...
public class TimeArgument implements ArgumentType<Integer> {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TICK_COUNT_TOO_LOW = new Dynamic2CommandExceptionType((p_308389_, p_308390_) -> {
      return Component.translatableEscape("argument.time.tick_count_too_low", p_308390_, p_308389_);
   });
