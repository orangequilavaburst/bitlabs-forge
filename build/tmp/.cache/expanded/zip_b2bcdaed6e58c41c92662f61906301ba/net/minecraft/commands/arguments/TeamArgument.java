...
public class TeamArgument implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType ERROR_TEAM_NOT_FOUND = new DynamicCommandExceptionType((p_308388_) -> {
      return Component.translatableEscape("team.notFound", p_308388_);
   });
