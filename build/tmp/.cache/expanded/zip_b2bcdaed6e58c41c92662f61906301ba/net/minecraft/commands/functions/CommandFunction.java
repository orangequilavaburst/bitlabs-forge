...
public interface CommandFunction<T> {
   ...
   InstantiatedFunction<T> instantiate(@Nullable CompoundTag p_312196_, CommandDispatcher<T> p_309930_, T p_312979_) throws FunctionInstantiationException;
   ...
   static <T extends ExecutionCommandSource<T>> CommandFunction<T> fromLines(ResourceLocation p_312869_, CommandDispatcher<T> p_310963_, T p_312231_, List<String> p_310814_) {
