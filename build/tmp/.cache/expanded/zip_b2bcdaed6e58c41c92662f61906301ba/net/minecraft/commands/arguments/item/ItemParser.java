...
public class ItemParser {
   ...
   private static final DynamicCommandExceptionType ERROR_UNKNOWN_ITEM = new DynamicCommandExceptionType((p_308407_) -> {
      return Component.translatableEscape("argument.item.id.invalid", p_308407_);
   });
   private static final DynamicCommandExceptionType ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType((p_308406_) -> {
      return Component.translatableEscape("arguments.item.tag.unknown", p_308406_);
   });
