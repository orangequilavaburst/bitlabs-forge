...
public class ObjectiveArgument implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType ERROR_OBJECTIVE_NOT_FOUND = new DynamicCommandExceptionType((p_308353_) -> {
      return Component.translatableEscape("arguments.objective.notFound", p_308353_);
   });
   private static final DynamicCommandExceptionType ERROR_OBJECTIVE_READ_ONLY = new DynamicCommandExceptionType((p_308354_) -> {
      return Component.translatableEscape("arguments.objective.readonly", p_308354_);
   });
