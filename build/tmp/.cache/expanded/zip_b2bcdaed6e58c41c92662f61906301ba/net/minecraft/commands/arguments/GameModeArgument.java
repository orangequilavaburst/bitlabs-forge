...
public class GameModeArgument implements ArgumentType<GameType> {
   ...
   private static final DynamicCommandExceptionType ERROR_INVALID = new DynamicCommandExceptionType((p_308349_) -> {
      return Component.translatableEscape("argument.gamemode.invalid", p_308349_);
   });
