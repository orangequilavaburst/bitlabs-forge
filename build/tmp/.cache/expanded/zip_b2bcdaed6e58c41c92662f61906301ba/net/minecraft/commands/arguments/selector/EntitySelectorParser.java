...
public class EntitySelectorParser {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_SELECTOR_TYPE = new DynamicCommandExceptionType((p_308409_) -> {
      return Component.translatableEscape("argument.entity.selector.unknown", p_308409_);
   });
   ...
   public static final DynamicCommandExceptionType ERROR_EXPECTED_OPTION_VALUE = new DynamicCommandExceptionType((p_308408_) -> {
      return Component.translatableEscape("argument.entity.options.valueless", p_308408_);
   });
