...
public class ParticleArgument implements ArgumentType<ParticleOptions> {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_PARTICLE = new DynamicCommandExceptionType((p_308358_) -> {
      return Component.translatableEscape("particle.notFound", p_308358_);
   });
