...
public class ResourceKeyArgument<T> implements ArgumentType<ResourceKey<T>> {
   ...
   private static final DynamicCommandExceptionType ERROR_INVALID_FEATURE = new DynamicCommandExceptionType((p_308366_) -> {
      return Component.translatableEscape("commands.place.feature.invalid", p_308366_);
   });
   private static final DynamicCommandExceptionType ERROR_INVALID_STRUCTURE = new DynamicCommandExceptionType((p_308367_) -> {
      return Component.translatableEscape("commands.place.structure.invalid", p_308367_);
   });
   private static final DynamicCommandExceptionType ERROR_INVALID_TEMPLATE_POOL = new DynamicCommandExceptionType((p_308365_) -> {
      return Component.translatableEscape("commands.place.jigsaw.invalid", p_308365_);
   });
