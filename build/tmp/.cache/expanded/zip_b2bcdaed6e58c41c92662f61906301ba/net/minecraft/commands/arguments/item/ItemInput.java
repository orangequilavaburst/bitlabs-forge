...
public class ItemInput implements Predicate<ItemStack> {
   private static final Dynamic2CommandExceptionType ERROR_STACK_TOO_BIG = new Dynamic2CommandExceptionType((p_308404_, p_308405_) -> {
      return Component.translatableEscape("arguments.item.overstacked", p_308404_, p_308405_);
   });
