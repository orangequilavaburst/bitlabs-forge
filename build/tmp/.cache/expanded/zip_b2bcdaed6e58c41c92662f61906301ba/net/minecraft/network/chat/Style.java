...
public class Style {
   ...
   private static Style create(Optional<TextColor> p_237258_, Optional<Boolean> p_237259_, Optional<Boolean> p_237260_, Optional<Boolean> p_237261_, Optional<Boolean> p_237262_, Optional<Boolean> p_237263_, Optional<ClickEvent> p_237264_, Optional<HoverEvent> p_237265_, Optional<String> p_311416_, Optional<ResourceLocation> p_312643_) {
      Style style = new Style(p_237258_.orElse((TextColor)null), p_237259_.orElse((Boolean)null), p_237260_.orElse((Boolean)null), p_237261_.orElse((Boolean)null), p_237262_.orElse((Boolean)null), p_237263_.orElse((Boolean)null), p_237264_.orElse((ClickEvent)null), p_237265_.orElse((HoverEvent)null), p_311416_.orElse((String)null), p_312643_.orElse((ResourceLocation)null));
   ...
   public Style withColor(@Nullable TextColor p_131149_) {
      return Objects.equals(this.color, p_131149_) ? this : checkEmptyAfterChange(new Style(p_131149_, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.color, p_131149_);
   }
   ...
   public Style withBold(@Nullable Boolean p_131137_) {
      return Objects.equals(this.bold, p_131137_) ? this : checkEmptyAfterChange(new Style(this.color, p_131137_, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.bold, p_131137_);
   }

   public Style withItalic(@Nullable Boolean p_131156_) {
      return Objects.equals(this.italic, p_131156_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, p_131156_, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.italic, p_131156_);
   }

   public Style withUnderlined(@Nullable Boolean p_131163_) {
      return Objects.equals(this.underlined, p_131163_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, p_131163_, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.underlined, p_131163_);
   }

   public Style withStrikethrough(@Nullable Boolean p_178523_) {
      return Objects.equals(this.strikethrough, p_178523_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, p_178523_, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.strikethrough, p_178523_);
   }

   public Style withObfuscated(@Nullable Boolean p_178525_) {
      return Objects.equals(this.obfuscated, p_178525_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, this.strikethrough, p_178525_, this.clickEvent, this.hoverEvent, this.insertion, this.font), this.obfuscated, p_178525_);
   }

   public Style withClickEvent(@Nullable ClickEvent p_131143_) {
      return Objects.equals(this.clickEvent, p_131143_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, p_131143_, this.hoverEvent, this.insertion, this.font), this.clickEvent, p_131143_);
   }

   public Style withHoverEvent(@Nullable HoverEvent p_131145_) {
      return Objects.equals(this.hoverEvent, p_131145_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, p_131145_, this.insertion, this.font), this.hoverEvent, p_131145_);
   }

   public Style withInsertion(@Nullable String p_131139_) {
      return Objects.equals(this.insertion, p_131139_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, p_131139_, this.font), this.insertion, p_131139_);
   }

   public Style withFont(@Nullable ResourceLocation p_131151_) {
      return Objects.equals(this.font, p_131151_) ? this : checkEmptyAfterChange(new Style(this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, p_131151_), this.font, p_131151_);
   }
