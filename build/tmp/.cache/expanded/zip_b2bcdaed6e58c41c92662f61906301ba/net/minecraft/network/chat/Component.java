...
public interface Component extends Message, FormattedText {
   ...
   static Component translationArg(Message p_312086_) {
      Object object;
      if (p_312086_ instanceof Component component) {
         object = component;
      } else {
         object = literal(p_312086_.getString());
      }
   ...
   public static class Serializer {
      ...
      static JsonElement serialize(Component p_130706_) {
         return Util.getOrThrow(ComponentSerialization.CODEC.encodeStart(JsonOps.INSTANCE, p_130706_), JsonParseException::new);
      }

      public static String toJson(Component p_130704_) {
         return GSON.toJson(serialize(p_130704_));
      }

      public static JsonElement toJsonTree(Component p_130717_) {
         return serialize(p_130717_);
      }
      ...
      @Nullable
      public static MutableComponent fromJson(@Nullable JsonElement p_130692_) {
         return p_130692_ == null ? null : deserialize(p_130692_);
      }
