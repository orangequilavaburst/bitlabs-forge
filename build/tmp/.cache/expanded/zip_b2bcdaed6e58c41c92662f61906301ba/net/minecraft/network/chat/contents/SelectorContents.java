...
public class SelectorContents implements ComponentContents {
   ...
   public static final MapCodec<SelectorContents> CODEC = RecordCodecBuilder.mapCodec((p_312104_) -> {
      return p_312104_.group(Codec.STRING.fieldOf("selector").forGetter(SelectorContents::getPattern), ExtraCodecs.strictOptionalField(ComponentSerialization.CODEC, "separator").forGetter(SelectorContents::getSeparator)).apply(p_312104_, SelectorContents::new);
   });
