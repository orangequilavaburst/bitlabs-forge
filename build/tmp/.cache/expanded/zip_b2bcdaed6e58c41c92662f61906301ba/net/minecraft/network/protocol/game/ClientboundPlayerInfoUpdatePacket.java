...
public class ClientboundPlayerInfoUpdatePacket implements Packet<ClientGamePacketListener> {
   ...
   public static enum Action {
      ADD_PLAYER((p_251116_, p_251884_) -> {
         ...
         GameProfile gameprofile = Objects.requireNonNull(p_296404_.profile());
         p_296403_.writeUtf(gameprofile.getName(), 16);
         p_296403_.writeGameProfileProperties(gameprofile.getProperties());
      }),
      ...
      UPDATE_LISTED((p_248777_, p_248837_) -> {
         ...
         p_296405_.writeBoolean(p_296406_.listed());
      }),
      ...
      UPDATE_DISPLAY_NAME((p_248840_, p_251000_) -> {
         p_248840_.displayName = p_251000_.readNullable(FriendlyByteBuf::readComponentTrusted);
      }, (p_251723_, p_251870_) -> {
   ...
   public static record Entry(UUID profileId, @Nullable GameProfile profile, boolean listed, int latency, GameType gameMode, @Nullable Component displayName, @Nullable RemoteChatSession.Data chatSession) {
      Entry(ServerPlayer p_252094_) {
         this(p_252094_.getUUID(), p_252094_.getGameProfile(), true, p_252094_.connection.latency(), p_252094_.gameMode.getGameModeForPlayer(), p_252094_.getTabListDisplayName(), Optionull.map(p_252094_.getChatSession(), RemoteChatSession::asData));
      }
   }
