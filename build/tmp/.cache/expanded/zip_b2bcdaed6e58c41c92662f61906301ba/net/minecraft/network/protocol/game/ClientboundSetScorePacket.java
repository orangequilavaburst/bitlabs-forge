...
public record ClientboundSetScorePacket(String owner, String objectiveName, int score, @Nullable Component display, @Nullable NumberFormat numberFormat) implements Packet<ClientGamePacketListener> {
   public ClientboundSetScorePacket(FriendlyByteBuf p_179373_) {
      this(p_179373_.readUtf(), p_179373_.readUtf(), p_179373_.readVarInt(), p_179373_.readNullable(FriendlyByteBuf::readComponentTrusted), p_179373_.readNullable(NumberFormatTypes::readFromStream));
   }
