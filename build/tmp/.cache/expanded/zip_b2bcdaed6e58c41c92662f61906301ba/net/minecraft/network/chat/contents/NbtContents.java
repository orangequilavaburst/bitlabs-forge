...
public class NbtContents implements ComponentContents {
   ...
   public static final MapCodec<NbtContents> CODEC = RecordCodecBuilder.mapCodec((p_308580_) -> {
      return p_308580_.group(Codec.STRING.fieldOf("nbt").forGetter(NbtContents::getNbtPath), Codec.BOOL.optionalFieldOf("interpret", Boolean.valueOf(false)).forGetter(NbtContents::isInterpreting), ComponentSerialization.CODEC.optionalFieldOf("separator").forGetter(NbtContents::getSeparator), DataSource.CODEC.forGetter(NbtContents::getDataSource)).apply(p_308580_, NbtContents::new);
   });
