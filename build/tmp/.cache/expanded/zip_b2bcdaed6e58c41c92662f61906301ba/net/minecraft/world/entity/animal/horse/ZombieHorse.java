...
public class ZombieHorse extends AbstractHorse {
   ...
   public static boolean checkZombieHorseSpawnRules(EntityType<? extends Animal> p_313002_, LevelAccessor p_310822_, MobSpawnType p_312863_, BlockPos p_311078_, RandomSource p_312131_) {
      if (!MobSpawnType.isSpawner(p_312863_)) {
         return Animal.checkAnimalSpawnRules(p_313002_, p_310822_, p_312863_, p_311078_, p_312131_);
      } else {
         return MobSpawnType.ignoresLightRequirements(p_312863_) || isBrightEnoughToSpawn(p_310822_, p_311078_);
      }
   }
   ...
   protected float getPassengersRidingOffsetY(EntityDimensions p_298114_, float p_300304_) {
      return p_298114_.height - (this.isBaby() ? 0.03125F : 0.28125F) * p_300304_;
   }
}