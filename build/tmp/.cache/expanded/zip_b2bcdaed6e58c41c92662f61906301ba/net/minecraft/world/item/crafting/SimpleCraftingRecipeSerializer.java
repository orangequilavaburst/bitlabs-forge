...
public class SimpleCraftingRecipeSerializer<T extends CraftingRecipe> implements RecipeSerializer<T> {
   ...
   public SimpleCraftingRecipeSerializer(SimpleCraftingRecipeSerializer.Factory<T> p_250090_) {
      ...
      this.codec = RecordCodecBuilder.create((p_309259_) -> {
         return p_309259_.group(CraftingBookCategory.CODEC.fieldOf("category").orElse(CraftingBookCategory.MISC).forGetter(CraftingRecipe::category)).apply(p_309259_, p_250090_::create);
      });
   }
