...
public class ChunkStatus {
   ...
   public static final ChunkStatus STRUCTURE_STARTS = register("structure_starts", EMPTY, 0, false, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (p_309312_, p_309313_, p_309314_, p_309315_, p_309316_, p_309317_, p_309318_, p_309319_, p_309320_) -> {
      ...
      p_309314_.onStructureStartsAvailable(p_309320_);
      return CompletableFuture.completedFuture(Either.left(p_309320_));
   ...
   public static final ChunkStatus CARVERS = registerSimple("carvers", SURFACE, 8, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (p_309307_, p_309308_, p_309309_, p_309310_, p_309311_) -> {
      WorldGenRegion worldgenregion = new WorldGenRegion(p_309308_, p_309310_, p_309307_, 0);
      if (p_309311_ instanceof ProtoChunk protochunk) {
         Blender.addAroundOldChunksCarvingMaskFilter(worldgenregion, protochunk);
      }

      p_309309_.applyCarvers(worldgenregion, p_309308_.getSeed(), p_309308_.getChunkSource().randomState(), p_309308_.getBiomeManager(), p_309308_.structureManager().forWorldGenRegion(worldgenregion), p_309311_, GenerationStep.Carving.AIR);
   });
