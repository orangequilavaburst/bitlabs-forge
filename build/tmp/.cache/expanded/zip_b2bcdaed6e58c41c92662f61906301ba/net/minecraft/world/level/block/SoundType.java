...
public class SoundType {
   public static final SoundType EMPTY = new SoundType(1.0F, 1.0F, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY);
   ...
   public static final SoundType LILY_PAD = new SoundType(1.0F, 1.0F, SoundEvents.BIG_DRIPLEAF_BREAK, SoundEvents.BIG_DRIPLEAF_STEP, SoundEvents.LILY_PAD_PLACE, SoundEvents.BIG_DRIPLEAF_HIT, SoundEvents.BIG_DRIPLEAF_FALL);
   ...
   public static final SoundType FROGLIGHT = new SoundType(1.0F, 1.0F, SoundEvents.FROGLIGHT_BREAK, SoundEvents.FROGLIGHT_STEP, SoundEvents.FROGLIGHT_PLACE, SoundEvents.FROGLIGHT_HIT, SoundEvents.FROGLIGHT_FALL);
   ...
   public static final SoundType MANGROVE_ROOTS = new SoundType(1.0F, 1.0F, SoundEvents.MANGROVE_ROOTS_BREAK, SoundEvents.MANGROVE_ROOTS_STEP, SoundEvents.MANGROVE_ROOTS_PLACE, SoundEvents.MANGROVE_ROOTS_HIT, SoundEvents.MANGROVE_ROOTS_FALL);
   ...
   public static final SoundType NETHER_WOOD_HANGING_SIGN = new SoundType(1.0F, 1.0F, SoundEvents.NETHER_WOOD_HANGING_SIGN_BREAK, SoundEvents.NETHER_WOOD_HANGING_SIGN_STEP, SoundEvents.NETHER_WOOD_HANGING_SIGN_PLACE, SoundEvents.NETHER_WOOD_HANGING_SIGN_HIT, SoundEvents.NETHER_WOOD_HANGING_SIGN_FALL);
   ...
   public static final SoundType TRIAL_SPAWNER = new SoundType(1.0F, 1.0F, SoundEvents.TRIAL_SPAWNER_BREAK, SoundEvents.TRIAL_SPAWNER_STEP, SoundEvents.TRIAL_SPAWNER_PLACE, SoundEvents.TRIAL_SPAWNER_HIT, SoundEvents.TRIAL_SPAWNER_FALL);
   public static final SoundType SPONGE = new SoundType(1.0F, 1.0F, SoundEvents.SPONGE_BREAK, SoundEvents.SPONGE_STEP, SoundEvents.SPONGE_PLACE, SoundEvents.SPONGE_HIT, SoundEvents.SPONGE_FALL);
