...
public class MemoryModuleType<U> {
   ...
   private static <U> MemoryModuleType<U> register(String p_26391_, Codec<U> p_26392_) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(p_26391_), new MemoryModuleType<>(Optional.of(p_26392_)));
   }

   private static <U> MemoryModuleType<U> register(String p_26389_) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(p_26389_), new MemoryModuleType<>(Optional.empty()));
   }
}