...
public class MushroomCow extends Cow implements Shearable, net.minecraftforge.common.IForgeShearable {
   ...
   public void addAdditionalSaveData(CompoundTag p_28944_) {
      ...
      if (this.stewEffects != null) {
         SuspiciousEffectHolder.EffectEntry.LIST_CODEC.encodeStart(NbtOps.INSTANCE, this.stewEffects).result().ifPresent((p_296800_) -> {
            p_28944_.put("stew_effects", p_296800_);
         });
      }
   ...
   public void readAdditionalSaveData(CompoundTag p_28936_) {
      ...
      if (p_28936_.contains("stew_effects", 9)) {
         SuspiciousEffectHolder.EffectEntry.LIST_CODEC.parse(NbtOps.INSTANCE, p_28936_.get("stew_effects")).result().ifPresent((p_296801_) -> {
            this.stewEffects = p_296801_;
         });
      }
