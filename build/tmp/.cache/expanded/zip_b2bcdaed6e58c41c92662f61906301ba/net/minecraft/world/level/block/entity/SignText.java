...
public class SignText {
   private static final Codec<Component[]> LINES_CODEC = ComponentSerialization.FLAT_CODEC.listOf().comapFlatMap((p_277790_) -> {
   ...
   public static final Codec<SignText> DIRECT_CODEC = RecordCodecBuilder.create((p_277675_) -> {
      ...
      }), LINES_CODEC.optionalFieldOf("filtered_messages").forGetter(SignText::filteredMessages), DyeColor.CODEC.fieldOf("color").orElse(DyeColor.BLACK).forGetter((p_277343_) -> {
