...
public abstract class Raider extends PatrollingMonster {
   ...
   static final Predicate<ItemEntity> ALLOWED_ITEMS = (p_309223_) -> {
      return !p_309223_.hasPickUpDelay() && p_309223_.isAlive() && ItemStack.matches(p_309223_.getItem(), Raid.getLeaderBannerInstance());
   };
   @Nullable
   protected Raid raid;
   private int wave;
