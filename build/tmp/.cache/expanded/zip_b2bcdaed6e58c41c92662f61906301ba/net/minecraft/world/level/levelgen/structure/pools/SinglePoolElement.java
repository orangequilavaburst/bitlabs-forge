...
public class SinglePoolElement extends StructurePoolElement {
   ...
   static void sortBySelectionPriority(List<StructureTemplate.StructureBlockInfo> p_312992_) {
      p_312992_.sort(Comparator.<StructureTemplate.StructureBlockInfo>comparingInt((p_309349_) -> {
         return Optionull.mapOrDefault(p_309349_.nbt(), (p_309348_) -> {
            return p_309348_.getInt("selection_priority");
         }, 0);
      }).reversed());
   }
