...
public class Ghast extends FlyingMob implements Enemy {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, (p_309190_) -> {
         return Math.abs(p_309190_.getY() - this.getY()) <= 4.0D;
      }));
   }
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity p_298765_, EntityDimensions p_297996_, float p_300062_) {
      return new Vector3f(0.0F, p_297996_.height + 0.0625F * p_300062_, 0.0F);
   }
