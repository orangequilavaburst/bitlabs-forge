...
public class BottleItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
      List<AreaEffectCloud> list = p_40656_.getEntitiesOfClass(AreaEffectCloud.class, p_40657_.getBoundingBox().inflate(2.0D), (p_309228_) -> {
      ...
      if (!list.isEmpty()) {
         ...
         if (p_40657_ instanceof ServerPlayer) {
            ServerPlayer serverplayer = (ServerPlayer)p_40657_;
