...
public abstract class BaseSpawner {
         ...
         if (this.spawnDelay > 0) {
            ...
            for(int i = 0; i < this.spawnCount; ++i) {
               ...
               if (p_151312_.noCollision(optional.get().getAABB(d0, d1, d2))) {
                  ...
                  int k = p_151312_.getEntities(EntityTypeTest.forExactClass(entity.getClass()), (new AABB((double)p_151313_.getX(), (double)p_151313_.getY(), (double)p_151313_.getZ(), (double)(p_151313_.getX() + 1), (double)(p_151313_.getY() + 1), (double)(p_151313_.getZ() + 1))).inflate((double)this.spawnRange), EntitySelector.NO_SPECTATORS).size();
   ...
   public void load(@Nullable Level p_151329_, BlockPos p_151330_, CompoundTag p_151331_) {
      ...
      if (flag) {
         SpawnData spawndata = SpawnData.CODEC.parse(NbtOps.INSTANCE, p_151331_.getCompound("SpawnData")).resultOrPartial((p_186391_) -> {
   ...
   private SpawnData getOrCreateNextSpawnData(@Nullable Level p_254503_, RandomSource p_253892_, BlockPos p_254487_) {
      if (this.nextSpawnData != null) {
         ...
         this.setNextSpawnData(p_254503_, p_254487_, this.spawnPotentials.getRandom(p_253892_).map(WeightedEntry.Wrapper::getData).orElseGet(SpawnData::new));
         return this.nextSpawnData;
      }
   }
