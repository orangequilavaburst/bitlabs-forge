...
public interface Spawner {
   ...
   static Component getSpawnEntityDisplayName(ItemStack p_312162_, String p_309907_) {
      CompoundTag compoundtag = BlockItem.getBlockEntityData(p_312162_);
      if (compoundtag != null) {
         ResourceLocation resourcelocation = getEntityKey(compoundtag, p_309907_);
         if (resourcelocation != null) {
            return BuiltInRegistries.ENTITY_TYPE.getOptional(resourcelocation).map((p_311493_) -> {
               return Component.translatable(p_311493_.getDescriptionId()).withStyle(ChatFormatting.GRAY);
