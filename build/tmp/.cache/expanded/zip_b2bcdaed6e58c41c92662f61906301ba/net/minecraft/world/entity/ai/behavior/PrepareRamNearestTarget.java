...
public class PrepareRamNearestTarget<E extends PathfinderMob> extends Behavior<E> {
         ...
         if (flag) {
            ...
            if (blockpos.equals(this.ramCandidate.get().getStartPosition())) {
               ...
               if (p_147786_ - this.reachedRamPositionTimestamp.get() >= (long)this.ramPrepareTime) {
                  ...
                  p_147784_.playSound((Player)null, p_147785_, this.getPrepareRamSound.apply(p_147785_), SoundSource.NEUTRAL, 1.0F, p_147785_.getVoicePitch());
   ...
   private void chooseRamPosition(PathfinderMob p_147766_, LivingEntity p_147767_) {
      ...
      this.ramCandidate = this.calculateRammingStartPosition(p_147766_, p_147767_).map((p_309087_) -> {
         return new PrepareRamNearestTarget.RamCandidate(p_309087_, p_147767_.blockPosition(), p_147767_);
      });
   }
