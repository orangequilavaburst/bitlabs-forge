...
public class SkeletonHorse extends AbstractHorse {
   ...
   public static boolean checkSkeletonHorseSpawnRules(EntityType<? extends Animal> p_312158_, LevelAccessor p_312297_, MobSpawnType p_312214_, BlockPos p_312728_, RandomSource p_309547_) {
      if (!MobSpawnType.isSpawner(p_312214_)) {
         return Animal.checkAnimalSpawnRules(p_312158_, p_312297_, p_312214_, p_312728_, p_309547_);
      } else {
         return MobSpawnType.ignoresLightRequirements(p_312214_) || isBrightEnoughToSpawn(p_312297_, p_312728_);
      }
   }
