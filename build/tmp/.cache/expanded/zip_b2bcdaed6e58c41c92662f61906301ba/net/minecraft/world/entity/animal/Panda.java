...
public class Panda extends Animal {
   ...
   static final Predicate<ItemEntity> PANDA_ITEMS = (p_309169_) -> {
      ItemStack itemstack = p_309169_.getItem();
      return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_309169_.isAlive() && !p_309169_.hasPickUpDelay();
   };
   ...
   public void addAdditionalSaveData(CompoundTag p_29129_) {
      ...
      p_29129_.putString("MainGene", this.getMainGene().getSerializedName());
      p_29129_.putString("HiddenGene", this.getHiddenGene().getSerializedName());
   }
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity p_297263_, EntityDimensions p_298830_, float p_300167_) {
      return new Vector3f(0.0F, p_298830_.height - (this.isBaby() ? 0.4375F : 0.0F) * p_300167_, 0.0F);
   }
   ...
   public static enum Gene implements StringRepresentable {
      ...
      public static Panda.Gene byName(String p_29254_) {
         return CODEC.byName(p_29254_, NORMAL);
      }
