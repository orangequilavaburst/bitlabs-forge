...
public class Guardian extends Monster {
   ...
   public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> p_218991_, LevelAccessor p_218992_, MobSpawnType p_218993_, BlockPos p_218994_, RandomSource p_218995_) {
      return (p_218995_.nextInt(20) == 0 || !p_218992_.canSeeSkyFromBelowWater(p_218994_)) && p_218992_.getDifficulty() != Difficulty.PEACEFUL && (MobSpawnType.isSpawner(p_218993_) || p_218992_.getFluidState(p_218994_).is(FluidTags.WATER)) && p_218992_.getFluidState(p_218994_.below()).is(FluidTags.WATER);
   }
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity p_298635_, EntityDimensions p_297893_, float p_297810_) {
