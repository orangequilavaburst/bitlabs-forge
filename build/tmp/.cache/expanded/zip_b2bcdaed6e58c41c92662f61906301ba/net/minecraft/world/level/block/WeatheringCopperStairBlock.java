...
public class WeatheringCopperStairBlock extends StairBlock implements WeatheringCopper {
   public static final MapCodec<WeatheringCopperStairBlock> CODEC = RecordCodecBuilder.mapCodec((p_311618_) -> {
      return p_311618_.group(WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state").forGetter(ChangeOverTimeBlock::getAge), BlockState.CODEC.fieldOf("base_state").forGetter((p_312323_) -> {
         return p_312323_.baseState;
      }), propertiesCodec()).apply(p_311618_, WeatheringCopperStairBlock::new);
   });
