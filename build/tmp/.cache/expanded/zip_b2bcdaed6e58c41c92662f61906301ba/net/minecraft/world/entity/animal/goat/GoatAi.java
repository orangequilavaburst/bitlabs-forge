...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat().selector((p_309179_) -> {
      return !p_309179_.getType().equals(EntityType.GOAT) && p_309179_.level().getWorldBorder().isWithinBounds(p_309179_.getBoundingBox());
   });
   ...
   private static void initIdleActivity(Brain<Goat> p_149458_) {
      p_149458_.addActivityWithConditions(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(0, new AnimalMakeLove(EntityType.GOAT, 1.0F)), Pair.of(1, new FollowTemptation((p_149446_) -> {
         return 1.25F;
   ...
   private static void initRamActivity(Brain<Goat> p_149466_) {
      ...
      }, RAM_TARGET_CONDITIONS, 3.0F, (p_309178_) -> {
         return p_309178_.isBaby() ? 1.0D : 2.5D;
      }, (p_149468_) -> {
         return p_149468_.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_RAM_IMPACT : SoundEvents.GOAT_RAM_IMPACT;
      }, (p_218772_) -> {
         return p_218772_.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_HORN_BREAK : SoundEvents.GOAT_HORN_BREAK;
      })), Pair.of(1, new PrepareRamNearestTarget<>((p_218770_) -> {
         return p_218770_.isScreamingGoat() ? TIME_BETWEEN_RAMS_SCREAMER.getMinValue() : TIME_BETWEEN_RAMS.getMinValue();
      }, 4, 7, 1.25F, RAM_TARGET_CONDITIONS, 20, (p_218768_) -> {
         return p_218768_.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_PREPARE_RAM : SoundEvents.GOAT_PREPARE_RAM;
