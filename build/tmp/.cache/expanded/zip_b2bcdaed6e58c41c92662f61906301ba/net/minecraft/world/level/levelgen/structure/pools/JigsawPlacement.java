...
public class JigsawPlacement {
   ...
   public static Optional<Structure.GenerationStub> addPieces(Structure.GenerationContext p_227239_, Holder<StructureTemplatePool> p_227240_, Optional<ResourceLocation> p_227241_, int p_227242_, BlockPos p_227243_, boolean p_227244_, Optional<Heightmap.Types> p_227245_, int p_227246_, PoolAliasLookup p_312146_) {
      ...
      StructureTemplatePool structuretemplatepool = p_227240_.unwrapKey().flatMap((p_309329_) -> {
         return registry.getOptional(p_312146_.lookup(p_309329_));
      ...
      if (structurepoolelement == EmptyPoolElement.INSTANCE) {
         ...
         int i1 = k + vec3i.getY();
         return Optional.of(new Structure.GenerationStub(new BlockPos(i, i1, j), (p_309345_) -> {
            ...
            if (p_227242_ > 0) {
               ...
               addPieces(p_227239_.randomState(), p_227242_, p_227244_, chunkgenerator, structuretemplatemanager, levelheightaccessor, worldgenrandom, registry, poolelementstructurepiece, list, voxelshape, p_312146_);
               list.forEach(p_309345_::addPiece);
            }
         }));
      }
   }
   ...
   private static Optional<BlockPos> getRandomNamedJigsaw(StructurePoolElement p_227248_, ResourceLocation p_227249_, BlockPos p_227250_, Rotation p_227251_, StructureTemplateManager p_227252_, WorldgenRandom p_227253_) {
      ...
      for(StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo : list) {
         ResourceLocation resourcelocation = ResourceLocation.tryParse(Objects.requireNonNull(structuretemplate$structureblockinfo.nbt(), () -> {
            return structuretemplate$structureblockinfo + " nbt was null";
         }).getString("name"));
   ...
   private static void addPieces(RandomState p_227211_, int p_227212_, boolean p_227213_, ChunkGenerator p_227214_, StructureTemplateManager p_227215_, LevelHeightAccessor p_227216_, RandomSource p_227217_, Registry<StructureTemplatePool> p_227218_, PoolElementStructurePiece p_227219_, List<PoolElementStructurePiece> p_227220_, VoxelShape p_227221_, PoolAliasLookup p_312553_) {
      ...
      jigsawplacement$placer.tryPlacingChildren(p_227219_, new MutableObject<>(p_227221_), 0, p_227213_, p_227216_, p_227211_, p_312553_);
      ...
      while(jigsawplacement$placer.placing.hasNext()) {
         ...
         jigsawplacement$placer.tryPlacingChildren(jigsawplacement$piecestate.piece, jigsawplacement$piecestate.free, jigsawplacement$piecestate.depth, p_227213_, p_227216_, p_227211_, p_312553_);
      }
   ...
   public static boolean generateJigsaw(ServerLevel p_227204_, Holder<StructureTemplatePool> p_227205_, ResourceLocation p_227206_, int p_227207_, BlockPos p_227208_, boolean p_227209_) {
      ...
      Optional<Structure.GenerationStub> optional = addPieces(structure$generationcontext, p_227205_, Optional.of(p_227206_), p_227207_, p_227208_, false, Optional.empty(), 128, PoolAliasLookup.EMPTY);
   ...
   static final class Placer {
      ...
      void tryPlacingChildren(PoolElementStructurePiece p_227265_, MutableObject<VoxelShape> p_227266_, int p_227267_, boolean p_227268_, LevelHeightAccessor p_227269_, RandomState p_227270_, PoolAliasLookup p_311045_) {
            ...
            if (optional.isEmpty()) {
               ...
               if (holder.value().size() == 0 && !holder.is(Pools.EMPTY)) {
                  ...
                  if (holder1.value().size() == 0 && !holder1.is(Pools.EMPTY)) {
                     JigsawPlacement.LOGGER.warn("Empty or non-existent fallback pool: {}", holder1.unwrapKey().map((p_255599_) -> {
                     ...
                     for(StructurePoolElement structurepoolelement1 : list) {
                        ...
                        for(Rotation rotation1 : Rotation.getShuffled(this.random)) {
                           ...
                           if (p_227268_ && boundingbox1.getYSpan() <= 16) {
                              i1 = list1.stream().mapToInt((p_255598_) -> {
                           ...
                           for(StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo1 : list1) {
                              if (JigsawBlock.canAttach(structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1)) {
                                 ...
                                 if (!Shapes.joinIsNotEmpty(mutableobject1.getValue(), Shapes.create(AABB.of(boundingbox3).deflate(0.25D)), BooleanOp.ONLY_SECOND)) {
                                    ...
                                    PoolElementStructurePiece poolelementstructurepiece = new PoolElementStructurePiece(this.structureTemplateManager, structurepoolelement1, blockpos5, l2, rotation1, boundingbox3);
                                    int i3;
                                    if (flag) {
                                       i3 = i + j;
                                    } else if (flag2) {
                                    ...
                                    p_227265_.addJunction(new JigsawJunction(blockpos2.getX(), i3 - j + j3, blockpos2.getZ(), l1, structuretemplatepool$projection1));
                                    ...
                                    if (p_227267_ + 1 <= this.maxDepth) {
                                       JigsawPlacement.PieceState jigsawplacement$piecestate = new JigsawPlacement.PieceState(poolelementstructurepiece, mutableobject1, p_227267_ + 1);
      ...
      private static ResourceKey<StructureTemplatePool> readPoolKey(StructureTemplate.StructureBlockInfo p_309775_, PoolAliasLookup p_310642_) {
         CompoundTag compoundtag = Objects.requireNonNull(p_309775_.nbt(), () -> {
            return p_309775_ + " nbt was null";
         });
