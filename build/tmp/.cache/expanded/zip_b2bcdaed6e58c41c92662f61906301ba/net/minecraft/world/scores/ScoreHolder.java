...
public interface ScoreHolder {
   ...
   default Component getFeedbackDisplayName() {
      ...
      return component != null ? component.copy().withStyle((p_312428_) -> {
         return p_312428_.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal(this.getScoreboardName())));
