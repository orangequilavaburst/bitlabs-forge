...
public class AABB {
   ...
   public static AABB encapsulatingFullBlocks(BlockPos p_310039_, BlockPos p_309686_) {
      return new AABB((double)Math.min(p_310039_.getX(), p_309686_.getX()), (double)Math.min(p_310039_.getY(), p_309686_.getY()), (double)Math.min(p_310039_.getZ(), p_309686_.getZ()), (double)(Math.max(p_310039_.getX(), p_309686_.getX()) + 1), (double)(Math.max(p_310039_.getY(), p_309686_.getY()) + 1), (double)(Math.max(p_310039_.getZ(), p_309686_.getZ()) + 1));
   }
