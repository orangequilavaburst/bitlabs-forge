   ...
   private Optional<BlockState> evaluateNewBlockState(Level p_312809_, BlockPos p_313114_, @Nullable Player p_312029_, BlockState p_311198_) {
      ...
      if (optional.isPresent()) {
         ...
         if (optional1.isPresent()) {
            ...
            Optional<BlockState> optional2 = Optional.ofNullable(HoneycombItem.WAX_OFF_BY_BLOCK.get().get(p_311198_.getBlock())).map((p_150694_) -> {
               return p_150694_.withPropertiesOf(p_311198_);
            });
