...
public class WanderingTrader extends AbstractVillager {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.INVISIBILITY), SoundEvents.WANDERING_TRADER_DISAPPEARED, (p_309214_) -> {
         return this.level().isNight() && !p_309214_.isInvisible();
      }));
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, (p_309213_) -> {
         return this.level().isDay() && p_309213_.isInvisible();
      }));
