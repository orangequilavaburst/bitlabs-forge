...
public class BreezeAi {
   ...
   protected static Brain<?> makeBrain(Brain<Breeze> p_311919_) {
      initCoreActivity(p_311919_);
      initFightActivity(p_311919_);
   ...
   private static void initCoreActivity(Brain<Breeze> p_312238_) {
      p_312238_.addActivity(Activity.CORE, 0, ImmutableList.of(new Swim(0.8F), new LookAtTargetSink(45, 90), new BreezeAi.SlideToTargetSink(20, 100)));
   }

   private static void initFightActivity(Brain<Breeze> p_310469_) {
      p_310469_.addActivityWithConditions(Activity.FIGHT, ImmutableList.of(Pair.of(0, StartAttacking.create((p_312068_) -> {
