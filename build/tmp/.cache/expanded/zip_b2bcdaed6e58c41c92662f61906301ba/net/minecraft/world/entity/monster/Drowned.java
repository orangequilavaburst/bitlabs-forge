...
public class Drowned extends Zombie implements RangedAttackMob {
   ...
   public static boolean checkDrownedSpawnRules(EntityType<Drowned> p_218956_, ServerLevelAccessor p_218957_, MobSpawnType p_218958_, BlockPos p_218959_, RandomSource p_218960_) {
      if (!p_218957_.getFluidState(p_218959_.below()).is(FluidTags.WATER) && !MobSpawnType.isSpawner(p_218958_)) {
         ...
         boolean flag = p_218957_.getDifficulty() != Difficulty.PEACEFUL && (MobSpawnType.ignoresLightRequirements(p_218958_) || isDarkEnoughToSpawn(p_218957_, p_218959_, p_218960_)) && (MobSpawnType.isSpawner(p_218958_) || p_218957_.getFluidState(p_218959_).is(FluidTags.WATER));
         if (flag && MobSpawnType.isSpawner(p_218958_)) {
            return true;
         } else if (holder.is(BiomeTags.MORE_FREQUENT_DROWNED_SPAWNS)) {
