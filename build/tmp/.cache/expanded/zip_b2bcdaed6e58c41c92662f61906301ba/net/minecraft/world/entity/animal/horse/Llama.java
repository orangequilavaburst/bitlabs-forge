...
public class Llama extends AbstractChestedHorse implements VariantHolder<Llama.Variant>, RangedAttackMob {
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity p_298288_, EntityDimensions p_300390_, float p_300878_) {
      return new Vector3f(0.0F, p_300390_.height - (this.isBaby() ? 0.8125F : 0.5F) * p_300878_, -0.3F * p_300878_);
   }

   static class LlamaAttackWolfGoal extends NearestAttackableTargetGoal<Wolf> {
      public LlamaAttackWolfGoal(Llama p_30843_) {
         super(p_30843_, Wolf.class, 16, false, true, (p_309180_) -> {
            return !((Wolf)p_309180_).isTame();
         });
      }
