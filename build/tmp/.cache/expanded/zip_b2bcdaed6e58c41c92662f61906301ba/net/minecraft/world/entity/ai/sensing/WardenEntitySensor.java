...
public class WardenEntitySensor extends NearestLivingEntitySensor<Warden> {
   ...
   protected void doTick(ServerLevel p_217833_, Warden p_217834_) {
      ...
      getClosest(p_217834_, (p_309137_) -> {
         return p_309137_.getType() == EntityType.PLAYER;
      }).or(() -> {
         return getClosest(p_217834_, (p_309136_) -> {
            return p_309136_.getType() != EntityType.PLAYER;
         });
