...
public class Pufferfish extends AbstractFish {
   ...
   int inflateCounter;
   int deflateTimer;
   private static final Predicate<LivingEntity> SCARY_MOB = (p_309171_) -> {
      if (p_309171_ instanceof Player && ((Player)p_309171_).isCreative()) {
         return false;
      } else {
         return p_309171_.getType() == EntityType.AXOLOTL || p_309171_.getMobType() != MobType.WATER;
      }
   };
   ...
   public void playerTouch(Player p_29617_) {
      int i = this.getPuffState();
      if (p_29617_ instanceof ServerPlayer && i > 0 && p_29617_.hurt(this.damageSources().mobAttack(this), (float)(1 + i))) {
         if (!this.isSilent()) {
