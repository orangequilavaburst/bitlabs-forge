...
public interface MinMaxBounds<T extends Number> {
   ...
   static <T extends Number, R extends MinMaxBounds<T>> Codec<R> createCodec(Codec<T> p_297837_, MinMaxBounds.BoundsFactory<T, R> p_298619_) {
      Codec<R> codec = RecordCodecBuilder.create((p_299567_) -> {
         return p_299567_.group(ExtraCodecs.strictOptionalField(p_297837_, "min").forGetter(MinMaxBounds::min), ExtraCodecs.strictOptionalField(p_297837_, "max").forGetter(MinMaxBounds::max)).apply(p_299567_, p_298619_::create);
      });
      return Codec.either(codec, p_297837_).xmap((p_299505_) -> {
         return p_299505_.map((p_300863_) -> {
            return p_300863_;
         }, (p_300712_) -> {
            return p_298619_.create(Optional.of(p_300712_), Optional.of(p_300712_));
         });
      }, (p_300263_) -> {
         Optional<T> optional = p_300263_.unwrapPoint();
         return optional.isPresent() ? Either.right(optional.get()) : Either.left(p_300263_);
      });
   }

   static <T extends Number, R extends MinMaxBounds<T>> R fromReader(StringReader p_55314_, MinMaxBounds.BoundsFromReaderFactory<T, R> p_55315_, Function<String, T> p_55316_, Supplier<DynamicCommandExceptionType> p_55317_, Function<T, T> p_55318_) throws CommandSyntaxException {
      if (!p_55314_.canRead()) {
   ...
   public static record Doubles(Optional<Double> min, Optional<Double> max, Optional<Double> minSq, Optional<Double> maxSq) implements MinMaxBounds<Double> {
      ...
      private static Optional<Double> squareOpt(Optional<Double> p_299805_) {
         return p_299805_.map((p_296138_) -> {
            return p_296138_ * p_296138_;
         });
      }
      ...
      public static MinMaxBounds.Doubles fromReader(StringReader p_154800_, Function<Double, Double> p_154801_) throws CommandSyntaxException {
         return MinMaxBounds.fromReader(p_154800_, MinMaxBounds.Doubles::create, Double::parseDouble, CommandSyntaxException.BUILT_IN_EXCEPTIONS::readerInvalidDouble, p_154801_);
      }
   ...
   public static record Ints(Optional<Integer> min, Optional<Integer> max, Optional<Long> minSq, Optional<Long> maxSq) implements MinMaxBounds<Integer> {
      ...
      private Ints(Optional<Integer> p_299979_, Optional<Integer> p_297344_) {
         this(p_299979_, p_297344_, p_299979_.map((p_296140_) -> {
            return p_296140_.longValue() * p_296140_.longValue();
         }), squareOpt(p_297344_));
      }
      ...
      private static Optional<Long> squareOpt(Optional<Integer> p_300285_) {
         return p_300285_.map((p_296139_) -> {
            return p_296139_.longValue() * p_296139_.longValue();
         });
      }
      ...
      public static MinMaxBounds.Ints fromReader(StringReader p_55382_, Function<Integer, Integer> p_55383_) throws CommandSyntaxException {
         return MinMaxBounds.fromReader(p_55382_, MinMaxBounds.Ints::create, Integer::parseInt, CommandSyntaxException.BUILT_IN_EXCEPTIONS::readerInvalidInt, p_55383_);
      }
