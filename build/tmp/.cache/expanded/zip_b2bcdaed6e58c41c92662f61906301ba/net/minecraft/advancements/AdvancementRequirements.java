...
public record AdvancementRequirements(List<List<String>> requirements) {
   ...
   public AdvancementRequirements(FriendlyByteBuf p_299417_) {
      this(p_299417_.readList((p_308101_) -> {
         return p_308101_.readList(FriendlyByteBuf::readUtf);
      }));
   }

   public void write(FriendlyByteBuf p_299546_) {
      p_299546_.writeCollection(this.requirements, (p_308104_, p_308105_) -> {
         p_308104_.writeCollection(p_308105_, FriendlyByteBuf::writeUtf);
      });
   }
   ...
   public DataResult<AdvancementRequirements> validate(Set<String> p_311051_) {
      ...
      if (!p_311051_.equals(set)) {
         ...
         return DataResult.error(() -> {
            return "Advancement completion requirements did not exactly match specified criteria. Missing: " + set1 + ". Unknown: " + set2;
         });
      } else {
