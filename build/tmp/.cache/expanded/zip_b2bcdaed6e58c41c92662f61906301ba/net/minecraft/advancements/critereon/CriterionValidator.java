...
public class CriterionValidator {
   ...
   public CriterionValidator(ProblemReporter p_311865_, LootDataResolver p_312779_) {
      this.reporter = p_311865_;
      this.lootData = p_312779_;
   }

   public void validateEntity(Optional<ContextAwarePredicate> p_311203_, String p_309703_) {
      p_311203_.ifPresent((p_312443_) -> {
         this.validateEntity(p_312443_, p_309703_);
      });
   }
