...
public class DamageCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_270226_, CommandBuildContext p_270136_) {
      ...
      }).then(Commands.argument("target", EntityArgument.entity()).then(Commands.argument("amount", FloatArgumentType.floatArg(0.0F)).executes((p_308642_) -> {
         return damage(p_308642_.getSource(), EntityArgument.getEntity(p_308642_, "target"), FloatArgumentType.getFloat(p_308642_, "amount"), p_308642_.getSource().getLevel().damageSources().generic());
