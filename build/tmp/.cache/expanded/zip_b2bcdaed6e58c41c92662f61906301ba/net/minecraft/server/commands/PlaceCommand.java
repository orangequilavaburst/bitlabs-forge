...
public class PlaceCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType((p_308787_) -> {
      return Component.translatableEscape("commands.place.template.invalid", p_308787_);
   });
   ...
   public static int placeStructure(CommandSourceStack p_214588_, Holder.Reference<Structure> p_251799_, BlockPos p_214590_) throws CommandSyntaxException {
      ...
      if (!structurestart.isValid()) {
         ...
         ChunkPos.rangeClosed(chunkpos, chunkpos1).forEach((p_308784_) -> {
            structurestart.placeInChunk(serverlevel, serverlevel.structureManager(), chunkgenerator, serverlevel.getRandom(), new BoundingBox(p_308784_.getMinBlockX(), serverlevel.getMinBuildHeight(), p_308784_.getMinBlockZ(), p_308784_.getMaxBlockX(), serverlevel.getMaxBuildHeight(), p_308784_.getMaxBlockZ()), p_308784_);
         });
      ...
      if (optional.isEmpty()) {
         ...
         if (!flag) {
            ...
            p_214562_.sendSuccess(() -> {
               return Component.translatable("commands.place.template.success", Component.translationArg(p_214563_), p_214564_.getX(), p_214564_.getY(), p_214564_.getZ());
            }, true);
            return 1;
         }
      }
   ...
   private static void checkLoaded(ServerLevel p_214544_, ChunkPos p_214545_, ChunkPos p_214546_) throws CommandSyntaxException {
      if (ChunkPos.rangeClosed(p_214545_, p_214546_).filter((p_308780_) -> {
         return !p_214544_.isLoaded(p_308780_.getWorldPosition());
      }).findAny().isPresent()) {
