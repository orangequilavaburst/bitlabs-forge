...
public class SpreadPlayersCommand {
   ...
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_TEAMS = new Dynamic4CommandExceptionType((p_308883_, p_308884_, p_308885_, p_308886_) -> {
      return Component.translatableEscape("commands.spreadplayers.failed.teams", p_308883_, p_308884_, p_308885_, p_308886_);
   });
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_ENTITIES = new Dynamic4CommandExceptionType((p_308887_, p_308888_, p_308889_, p_308890_) -> {
      return Component.translatableEscape("commands.spreadplayers.failed.entities", p_308887_, p_308888_, p_308889_, p_308890_);
   });
   private static final Dynamic2CommandExceptionType ERROR_INVALID_MAX_HEIGHT = new Dynamic2CommandExceptionType((p_308892_, p_308893_) -> {
      return Component.translatableEscape("commands.spreadplayers.failed.invalid.height", p_308892_, p_308893_);
   });
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138697_) {
      ...
      }).then(Commands.argument("center", Vec2Argument.vec2()).then(Commands.argument("spreadDistance", FloatArgumentType.floatArg(0.0F)).then(Commands.argument("maxRange", FloatArgumentType.floatArg(1.0F)).then(Commands.argument("respectTeams", BoolArgumentType.bool()).then(Commands.argument("targets", EntityArgument.entities()).executes((p_308891_) -> {
         return spreadPlayers(p_308891_.getSource(), Vec2Argument.getVec2(p_308891_, "center"), FloatArgumentType.getFloat(p_308891_, "spreadDistance"), FloatArgumentType.getFloat(p_308891_, "maxRange"), p_308891_.getSource().getLevel().getMaxBuildHeight(), BoolArgumentType.getBool(p_308891_, "respectTeams"), EntityArgument.getEntities(p_308891_, "targets"));
