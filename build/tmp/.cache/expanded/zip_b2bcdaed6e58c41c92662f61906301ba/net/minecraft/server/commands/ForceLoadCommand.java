            ...
            if (j2 == 0) {
               ...
               if (j2 == 1) {
                  p_137686_.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (p_137689_ ? "added" : "removed") + ".single", Component.translationArg(chunkpos1), Component.translationArg(resourcekey.location()));
                  }, true);
               } else {
                  ChunkPos chunkpos2 = new ChunkPos(i1, j1);
                  ChunkPos chunkpos3 = new ChunkPos(k1, l1);
                  p_137686_.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (p_137689_ ? "added" : "removed") + ".multiple", Component.translationArg(chunkpos1), Component.translationArg(resourcekey.location()), Component.translationArg(chunkpos2), Component.translationArg(chunkpos3));
                  }, true);
               }
