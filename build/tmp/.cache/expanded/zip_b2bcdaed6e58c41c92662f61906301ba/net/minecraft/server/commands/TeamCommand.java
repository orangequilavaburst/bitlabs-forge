...
public class TeamCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138878_) {
      ...
      }))).then(Commands.literal("join").then(Commands.argument("team", TeamArgument.team()).executes((p_308898_) -> {
         return joinTeam(p_308898_.getSource(), TeamArgument.getTeam(p_308898_, "team"), Collections.singleton(p_308898_.getSource().getEntityOrException()));
   ...
   private static int leaveTeam(CommandSourceStack p_138918_, Collection<ScoreHolder> p_138919_) {
      ...
      if (p_138919_.size() == 1) {
         p_138918_.sendSuccess(() -> {
            return Component.translatable("commands.team.leave.success.single", getFirstMemberName(p_138919_));
         }, true);
      } else {
         p_138918_.sendSuccess(() -> {
   ...
   private static int joinTeam(CommandSourceStack p_138895_, PlayerTeam p_138896_, Collection<ScoreHolder> p_138897_) {
      ...
      if (p_138897_.size() == 1) {
         p_138895_.sendSuccess(() -> {
            return Component.translatable("commands.team.join.success.single", getFirstMemberName(p_138897_), p_138896_.getFormattedDisplayName());
         }, true);
      } else {
         p_138895_.sendSuccess(() -> {
