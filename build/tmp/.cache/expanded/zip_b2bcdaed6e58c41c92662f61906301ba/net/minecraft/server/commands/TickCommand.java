...
public class TickCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_309698_) {
      p_309698_.register(Commands.literal("tick").requires((p_313254_) -> {
   ...
   private static int step(CommandSourceStack p_312155_, int p_311495_) {
      ...
      if (flag) {
         p_312155_.sendSuccess(() -> {
            return Component.translatable("commands.tick.step.success", p_311495_);
         }, true);
      } else {
