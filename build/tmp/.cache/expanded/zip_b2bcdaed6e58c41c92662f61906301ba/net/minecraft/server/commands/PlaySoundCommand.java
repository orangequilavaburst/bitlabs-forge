      ...
      if (i == 0) {
         ...
         if (p_138162_.size() == 1) {
            p_138161_.sendSuccess(() -> {
               return Component.translatable("commands.playsound.success.single", Component.translationArg(p_138163_), p_138162_.iterator().next().getDisplayName());
            }, true);
         } else {
            p_138161_.sendSuccess(() -> {
               return Component.translatable("commands.playsound.success.multiple", Component.translationArg(p_138163_), p_138162_.size());
            }, true);
         }
