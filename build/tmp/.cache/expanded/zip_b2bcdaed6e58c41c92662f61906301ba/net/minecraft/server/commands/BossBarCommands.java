...
public class BossBarCommands {
   private static final DynamicCommandExceptionType ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType((p_308633_) -> {
      return Component.translatableEscape("commands.bossbar.create.failed", p_308633_);
   });
   private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType((p_308632_) -> {
      return Component.translatableEscape("commands.bossbar.unknown", p_308632_);
   });
