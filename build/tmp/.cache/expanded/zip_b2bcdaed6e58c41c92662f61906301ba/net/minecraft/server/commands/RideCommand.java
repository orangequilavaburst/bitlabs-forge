...
public class RideCommand {
   private static final DynamicCommandExceptionType ERROR_NOT_RIDING = new DynamicCommandExceptionType((p_308800_) -> {
      return Component.translatableEscape("commands.ride.not_riding", p_308800_);
   });
   private static final Dynamic2CommandExceptionType ERROR_ALREADY_RIDING = new Dynamic2CommandExceptionType((p_308801_, p_308802_) -> {
      return Component.translatableEscape("commands.ride.already_riding", p_308801_, p_308802_);
   });
   private static final Dynamic2CommandExceptionType ERROR_MOUNT_FAILED = new Dynamic2CommandExceptionType((p_308803_, p_308804_) -> {
      return Component.translatableEscape("commands.ride.mount.failure.generic", p_308803_, p_308804_);
   });
