...
public class ServerFunctionManager {
   ...
   public void execute(CommandFunction<CommandSourceStack> p_311911_, CommandSourceStack p_136114_) {
      ...
      profilerfiller.push(() -> {
         return "function " + p_311911_.id();
      });

      try {
         InstantiatedFunction<CommandSourceStack> instantiatedfunction = p_311911_.instantiate((CompoundTag)null, this.getDispatcher(), p_136114_);
         Commands.executeCommandInContext(p_136114_, (p_311172_) -> {
            ExecutionContext.queueInitialFunctionCall(p_311172_, instantiatedfunction, p_136114_, CommandResultCallback.EMPTY);
         });
