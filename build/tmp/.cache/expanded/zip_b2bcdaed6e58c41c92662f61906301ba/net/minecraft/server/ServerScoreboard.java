...
public class ServerScoreboard extends Scoreboard {
   ...
   public List<Packet<?>> getStartTrackingPackets(Objective p_136230_) {
      ...
      for(PlayerScoreEntry playerscoreentry : this.listPlayerScores(p_136230_)) {
         list.add(new ClientboundSetScorePacket(playerscoreentry.owner(), p_136230_.getName(), playerscoreentry.value(), playerscoreentry.display(), playerscoreentry.numberFormatOverride()));
      }
