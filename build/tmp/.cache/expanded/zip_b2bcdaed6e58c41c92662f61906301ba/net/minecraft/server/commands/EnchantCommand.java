...
public class EnchantCommand {
   private static final DynamicCommandExceptionType ERROR_NOT_LIVING_ENTITY = new DynamicCommandExceptionType((p_308654_) -> {
      return Component.translatableEscape("commands.enchant.failed.entity", p_308654_);
   });
   private static final DynamicCommandExceptionType ERROR_NO_ITEM = new DynamicCommandExceptionType((p_308650_) -> {
      return Component.translatableEscape("commands.enchant.failed.itemless", p_308650_);
   });
   private static final DynamicCommandExceptionType ERROR_INCOMPATIBLE = new DynamicCommandExceptionType((p_308653_) -> {
      return Component.translatableEscape("commands.enchant.failed.incompatible", p_308653_);
   });
   private static final Dynamic2CommandExceptionType ERROR_LEVEL_TOO_HIGH = new Dynamic2CommandExceptionType((p_308651_, p_308652_) -> {
      return Component.translatableEscape("commands.enchant.failed.level", p_308651_, p_308652_);
   });
