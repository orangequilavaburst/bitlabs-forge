...
public class ScoreboardCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_NO_VALUE = new Dynamic2CommandExceptionType((p_308842_, p_308843_) -> {
      return Component.translatableEscape("commands.scoreboard.players.get.null", p_308842_, p_308843_);
   });
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138469_) {
      ...
      }))).then(createRenderTypeModify()).then(Commands.literal("displayautoupdate").then(Commands.argument("value", BoolArgumentType.bool()).executes((p_308844_) -> {
         return setDisplayAutoUpdate(p_308844_.getSource(), ObjectiveArgument.getObjective(p_308844_, "objective"), BoolArgumentType.getBool(p_308844_, "value"));
      }))).then(addNumberFormats(Commands.literal("numberformat"), (p_308837_, p_308838_) -> {
         return setObjectiveFormat(p_308837_.getSource(), ObjectiveArgument.getObjective(p_308837_, "objective"), p_308838_);
      })))).then(Commands.literal("remove").then(Commands.argument("objective", ObjectiveArgument.objective()).executes((p_138577_) -> {
         return removeObjective(p_138577_.getSource(), ObjectiveArgument.getObjective(p_138577_, "objective"));
      }))).then(Commands.literal("setdisplay").then(Commands.argument("slot", ScoreboardSlotArgument.displaySlot()).executes((p_296535_) -> {
         return clearDisplaySlot(p_296535_.getSource(), ScoreboardSlotArgument.getDisplaySlot(p_296535_, "slot"));
      }).then(Commands.argument("objective", ObjectiveArgument.objective()).executes((p_296536_) -> {
         return setDisplaySlot(p_296536_.getSource(), ScoreboardSlotArgument.getDisplaySlot(p_296536_, "slot"), ObjectiveArgument.getObjective(p_296536_, "objective"));
      }))))).then(Commands.literal("players").then(Commands.literal("list").executes((p_138571_) -> {
         return listTrackedPlayers(p_138571_.getSource());
      }).then(Commands.argument("target", ScoreHolderArgument.scoreHolder()).suggests(ScoreHolderArgument.SUGGEST_SCORE_HOLDERS).executes((p_308852_) -> {
         return listTrackedPlayerScores(p_308852_.getSource(), ScoreHolderArgument.getName(p_308852_, "target"));
      ...
      }))))).then(Commands.literal("get").then(Commands.argument("target", ScoreHolderArgument.scoreHolder()).suggests(ScoreHolderArgument.SUGGEST_SCORE_HOLDERS).then(Commands.argument("objective", ObjectiveArgument.objective()).executes((p_308815_) -> {
         return getScore(p_308815_.getSource(), ScoreHolderArgument.getName(p_308815_, "target"), ObjectiveArgument.getObjective(p_308815_, "objective"));
      ...
      })))).then(Commands.literal("display").then(Commands.literal("name").then(Commands.argument("targets", ScoreHolderArgument.scoreHolders()).suggests(ScoreHolderArgument.SUGGEST_SCORE_HOLDERS).then(Commands.argument("objective", ObjectiveArgument.objective()).then(Commands.argument("name", ComponentArgument.textComponent()).executes((p_308819_) -> {
         return setScoreDisplay(p_308819_.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard(p_308819_, "targets"), ObjectiveArgument.getObjective(p_308819_, "objective"), ComponentArgument.getComponent(p_308819_, "name"));
      })).executes((p_308862_) -> {
         return setScoreDisplay(p_308862_.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard(p_308862_, "targets"), ObjectiveArgument.getObjective(p_308862_, "objective"), (Component)null);
      })))).then(Commands.literal("numberformat").then(Commands.argument("targets", ScoreHolderArgument.scoreHolders()).suggests(ScoreHolderArgument.SUGGEST_SCORE_HOLDERS).then(addNumberFormats(Commands.argument("objective", ObjectiveArgument.objective()), (p_308863_, p_308864_) -> {
         return setScoreNumberFormat(p_308863_.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard(p_308863_, "targets"), ObjectiveArgument.getObjective(p_308863_, "objective"), p_308864_);
   ...
   private static ArgumentBuilder<CommandSourceStack, ?> addNumberFormats(ArgumentBuilder<CommandSourceStack, ?> p_312441_, ScoreboardCommand.NumberFormatCommandExecutor p_310857_) {
      return p_312441_.then(Commands.literal("blank").executes((p_308836_) -> {
         return p_310857_.run(p_308836_, BlankFormat.INSTANCE);
      })).then(Commands.literal("fixed").then(Commands.argument("contents", ComponentArgument.textComponent()).executes((p_308824_) -> {
      ...
      }))).then(Commands.literal("styled").then(Commands.argument("style", StyleArgument.style()).executes((p_308869_) -> {
         Style style = StyleArgument.getStyle(p_308869_, "style");
         return p_310857_.run(p_308869_, new StyledFormat(style));
      }))).executes((p_308875_) -> {
         return p_310857_.run(p_308875_, (NumberFormat)null);
      });
   }
   ...
   private static int getScore(CommandSourceStack p_138499_, ScoreHolder p_311327_, Objective p_138501_) throws CommandSyntaxException {
      ...
      if (readonlyscoreinfo == null) {
         ...
         p_138499_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.get.success", p_311327_.getFeedbackDisplayName(), readonlyscoreinfo.value(), p_138501_.getFormattedDisplayName());
         }, false);
   ...
   private static int performOperation(CommandSourceStack p_138524_, Collection<ScoreHolder> p_138525_, Objective p_138526_, OperationArgument.Operation p_138527_, Collection<ScoreHolder> p_138528_, Objective p_138529_) throws CommandSyntaxException {
      ...
      if (p_138525_.size() == 1) {
         ...
         p_138524_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.operation.success.single", p_138526_.getFormattedDisplayName(), getFirstTargetName(p_138525_), j);
         }, true);
      } else {
         p_138524_.sendSuccess(() -> {
         ...
         if (i == 0) {
            ...
            if (p_138516_.size() == 1) {
               p_138515_.sendSuccess(() -> {
                  return Component.translatable("commands.scoreboard.players.enable.success.single", p_138517_.getFormattedDisplayName(), getFirstTargetName(p_138516_));
               }, true);
            } else {
               p_138515_.sendSuccess(() -> {
   ...
   private static int resetScores(CommandSourceStack p_138508_, Collection<ScoreHolder> p_138509_) {
      ...
      if (p_138509_.size() == 1) {
         p_138508_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.reset.all.single", getFirstTargetName(p_138509_));
         }, true);
      } else {
         p_138508_.sendSuccess(() -> {
   ...
   private static int resetScore(CommandSourceStack p_138541_, Collection<ScoreHolder> p_138542_, Objective p_138543_) {
      ...
      if (p_138542_.size() == 1) {
         p_138541_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.reset.specific.single", p_138543_.getFormattedDisplayName(), getFirstTargetName(p_138542_));
         }, true);
      } else {
         p_138541_.sendSuccess(() -> {
   ...
   private static int setScore(CommandSourceStack p_138519_, Collection<ScoreHolder> p_138520_, Objective p_138521_, int p_138522_) {
      ...
      if (p_138520_.size() == 1) {
         p_138519_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.set.success.single", p_138521_.getFormattedDisplayName(), getFirstTargetName(p_138520_), p_138522_);
         }, true);
      } else {
         p_138519_.sendSuccess(() -> {
      ...
      if (p_313172_ == null) {
         if (p_313027_.size() == 1) {
            p_311963_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.players.display.name.clear.success.single", getFirstTargetName(p_313027_), p_309793_.getFormattedDisplayName());
            }, true);
         } else {
            p_311963_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.players.display.name.clear.success.multiple", p_313027_.size(), p_309793_.getFormattedDisplayName());
            }, true);
         }
      } else if (p_313027_.size() == 1) {
         p_311963_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.display.name.set.success.single", p_313172_, getFirstTargetName(p_313027_), p_309793_.getFormattedDisplayName());
         }, true);
      } else {
         p_311963_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.display.name.set.success.multiple", p_313172_, p_313027_.size(), p_309793_.getFormattedDisplayName());
         }, true);
      }
      ...
      if (p_311948_ == null) {
         if (p_310803_.size() == 1) {
            p_310386_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.players.display.numberFormat.clear.success.single", getFirstTargetName(p_310803_), p_311141_.getFormattedDisplayName());
            }, true);
         } else {
            p_310386_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.players.display.numberFormat.clear.success.multiple", p_310803_.size(), p_311141_.getFormattedDisplayName());
            }, true);
         }
      } else if (p_310803_.size() == 1) {
         p_310386_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.single", getFirstTargetName(p_310803_), p_311141_.getFormattedDisplayName());
         }, true);
      } else {
         p_310386_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.multiple", p_310803_.size(), p_311141_.getFormattedDisplayName());
         }, true);
      }
   ...
   private static int addScore(CommandSourceStack p_138545_, Collection<ScoreHolder> p_138546_, Objective p_138547_, int p_138548_) {
      ...
      if (p_138546_.size() == 1) {
         ...
         p_138545_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.add.success.single", p_138548_, p_138547_.getFormattedDisplayName(), getFirstTargetName(p_138546_), j);
         }, true);
      } else {
         p_138545_.sendSuccess(() -> {
   ...
   private static int removeScore(CommandSourceStack p_138554_, Collection<ScoreHolder> p_138555_, Objective p_138556_, int p_138557_) {
      ...
      if (p_138555_.size() == 1) {
         ...
         p_138554_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.remove.success.single", p_138557_, p_138556_.getFormattedDisplayName(), getFirstTargetName(p_138555_), j);
         }, true);
      } else {
         p_138554_.sendSuccess(() -> {
   ...
   private static int listTrackedPlayerScores(CommandSourceStack p_138496_, ScoreHolder p_310716_) {
      ...
      if (object2intmap.isEmpty()) {
         p_138496_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.list.entity.empty", p_310716_.getFeedbackDisplayName());
         }, false);
      } else {
         p_138496_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.players.list.entity.success", p_310716_.getFeedbackDisplayName(), object2intmap.size());
         }, false);
         Object2IntMaps.fastForEach(object2intmap, (p_308821_) -> {
            p_138496_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.players.list.entity.entry", ((Objective)p_308821_.getKey()).getFormattedDisplayName(), p_308821_.getIntValue());
            }, false);
         });
      }
   ...
   private static int clearDisplaySlot(CommandSourceStack p_138478_, DisplaySlot p_301105_) throws CommandSyntaxException {
      ...
      if (scoreboard.getDisplayObjective(p_301105_) == null) {
         ...
         scoreboard.setDisplayObjective(p_301105_, (Objective)null);
         p_138478_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.objectives.display.cleared", p_301105_.getSerializedName());
         }, true);
         return 0;
      }
   }
   ...
   private static int setDisplaySlot(CommandSourceStack p_138481_, DisplaySlot p_300906_, Objective p_138483_) throws CommandSyntaxException {
      ...
      if (scoreboard.getDisplayObjective(p_300906_) == p_138483_) {
         ...
         p_138481_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.objectives.display.set", p_300906_.getSerializedName(), p_138483_.getDisplayName());
         }, true);
         return 0;
      }
   }
      ...
      if (p_310615_.displayAutoUpdate() != p_309996_) {
         ...
         if (p_309996_) {
            p_311402_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.objectives.modify.displayAutoUpdate.enable", p_310615_.getName(), p_310615_.getFormattedDisplayName());
            }, true);
         } else {
            p_311402_.sendSuccess(() -> {
               return Component.translatable("commands.scoreboard.objectives.modify.displayAutoUpdate.disable", p_310615_.getName(), p_310615_.getFormattedDisplayName());
            }, true);
         }
      }
   ...
   private static int setObjectiveFormat(CommandSourceStack p_312449_, Objective p_313010_, @Nullable NumberFormat p_310903_) {
      ...
      if (p_310903_ != null) {
         p_312449_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.objectives.modify.objectiveFormat.set", p_313010_.getName());
         }, true);
      } else {
         p_312449_.sendSuccess(() -> {
            return Component.translatable("commands.scoreboard.objectives.modify.objectiveFormat.clear", p_313010_.getName());
         }, true);
      }
   ...
   private static int addObjective(CommandSourceStack p_138503_, String p_138504_, ObjectiveCriteria p_138505_, Component p_138506_) throws CommandSyntaxException {
      ...
      if (scoreboard.getObjective(p_138504_) != null) {
         ...
         scoreboard.addObjective(p_138504_, p_138505_, p_138506_, p_138505_.getDefaultRenderType(), false, (NumberFormat)null);
