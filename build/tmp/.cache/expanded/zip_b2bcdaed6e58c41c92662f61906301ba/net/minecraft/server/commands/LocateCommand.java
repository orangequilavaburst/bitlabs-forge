...
public class LocateCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_NOT_FOUND = new DynamicCommandExceptionType((p_308765_) -> {
      return Component.translatableEscape("commands.locate.structure.not_found", p_308765_);
   });
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_INVALID = new DynamicCommandExceptionType((p_308764_) -> {
      return Component.translatableEscape("commands.locate.structure.invalid", p_308764_);
   });
   private static final DynamicCommandExceptionType ERROR_BIOME_NOT_FOUND = new DynamicCommandExceptionType((p_308763_) -> {
      return Component.translatableEscape("commands.locate.biome.not_found", p_308763_);
   });
   private static final DynamicCommandExceptionType ERROR_POI_NOT_FOUND = new DynamicCommandExceptionType((p_308766_) -> {
      return Component.translatableEscape("commands.locate.poi.not_found", p_308766_);
   });
