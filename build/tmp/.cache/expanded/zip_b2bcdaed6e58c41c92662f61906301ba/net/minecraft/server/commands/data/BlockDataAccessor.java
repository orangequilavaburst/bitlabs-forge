...
public class BlockDataAccessor implements DataAccessor {
   ...
   public Component getPrintSuccess(NbtPathArgument.NbtPath p_139301_, double p_139302_, int p_139303_) {
      return Component.translatable("commands.data.block.get", p_139301_.asString(), this.pos.getX(), this.pos.getY(), this.pos.getZ(), String.format(Locale.ROOT, "%.2f", p_139302_), p_139303_);
   }
}