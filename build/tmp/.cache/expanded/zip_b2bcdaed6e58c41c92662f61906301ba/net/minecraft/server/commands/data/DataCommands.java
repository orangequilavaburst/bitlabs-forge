...
public class DataCommands {
   ...
   private static final DynamicCommandExceptionType ERROR_GET_NOT_NUMBER = new DynamicCommandExceptionType((p_308925_) -> {
      return Component.translatableEscape("commands.data.get.invalid", p_308925_);
   });
   private static final DynamicCommandExceptionType ERROR_GET_NON_EXISTENT = new DynamicCommandExceptionType((p_308929_) -> {
      return Component.translatableEscape("commands.data.get.unknown", p_308929_);
   });
   ...
   private static final DynamicCommandExceptionType ERROR_EXPECTED_OBJECT = new DynamicCommandExceptionType((p_308924_) -> {
      return Component.translatableEscape("commands.data.modify.expected_object", p_308924_);
   });
   private static final DynamicCommandExceptionType ERROR_EXPECTED_VALUE = new DynamicCommandExceptionType((p_308928_) -> {
      return Component.translatableEscape("commands.data.modify.expected_value", p_308928_);
   });
   private static final Dynamic2CommandExceptionType ERROR_INVALID_SUBSTRING = new Dynamic2CommandExceptionType((p_308926_, p_308927_) -> {
      return Component.translatableEscape("commands.data.modify.invalid_substring", p_308926_, p_308927_);
   });
