...
public class ScheduleCommand {
   ...
   private static int schedule(CommandSourceStack p_138429_, Pair<ResourceLocation, Either<CommandFunction<CommandSourceStack>, Collection<CommandFunction<CommandSourceStack>>>> p_138430_, int p_138431_, boolean p_138432_) throws CommandSyntaxException {
      if (p_138431_ == 0) {
         ...
         p_138430_.getSecond().ifLeft((p_312526_) -> {
            ...
            p_138429_.sendSuccess(() -> {
               return Component.translatable("commands.schedule.created.function", Component.translationArg(resourcelocation), p_138431_, i);
            }, true);
         }).ifRight((p_288548_) -> {
            ...
            p_138429_.sendSuccess(() -> {
               return Component.translatable("commands.schedule.created.tag", Component.translationArg(resourcelocation), p_138431_, i);
            }, true);
         });
