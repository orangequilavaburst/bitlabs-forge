...
public class ClearInventoryCommands {
   private static final DynamicCommandExceptionType ERROR_SINGLE = new DynamicCommandExceptionType((p_308637_) -> {
      return Component.translatableEscape("clear.failed.single", p_308637_);
   });
   private static final DynamicCommandExceptionType ERROR_MULTIPLE = new DynamicCommandExceptionType((p_308634_) -> {
      return Component.translatableEscape("clear.failed.multiple", p_308634_);
   });
