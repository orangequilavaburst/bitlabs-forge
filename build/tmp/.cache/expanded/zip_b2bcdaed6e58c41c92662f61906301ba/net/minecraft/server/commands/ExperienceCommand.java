...
public class ExperienceCommand {
   ...
   static enum Type {
      POINTS("points", Player::giveExperiencePoints, (p_308694_, p_308695_) -> {
         if (p_308695_ >= p_308694_.getXpNeededForNextLevel()) {
            return false;
         } else {
            p_308694_.setExperiencePoints(p_308695_);
            return true;
         }
      }, (p_308693_) -> {
         return Mth.floor(p_308693_.experienceProgress * (float)p_308693_.getXpNeededForNextLevel());
      }),
