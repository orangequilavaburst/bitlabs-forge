...
public class V3689 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_310273_) {
      ...
      p_310273_.register(map, "minecraft:breeze", () -> {
         return V100.equipment(p_310273_);
      });
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_309732_) {
      ...
      p_309732_.register(map, "minecraft:trial_spawner", () -> {
         return DSL.optionalFields("spawn_potentials", DSL.list(DSL.fields("data", DSL.fields("entity", References.ENTITY_TREE.in(p_309732_)))), "spawn_data", DSL.fields("entity", References.ENTITY_TREE.in(p_309732_)));
      });
      return map;
   }
}