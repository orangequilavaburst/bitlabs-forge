...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder p_14514_) {
      ...
      p_14514_.addFixer(new NamespacedTypeRenameFix(schema121, "Nether biome rename", References.BIOME, createRenamer("minecraft:nether", "minecraft:nether_wastes")));
      ...
      p_14514_.addFixer(new NamespacedTypeRenameFix(schema146, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES)));
      ...
      p_14514_.addFixer(new NamespacedTypeRenameFix(schema149, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      p_14514_.addFixer(new EntityVariantFix(schema161, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), (p_216528_) -> {
      ...
      p_14514_.addFixer(new CriteriaRenameFix(schema161, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (p_216517_) -> {
         return immutablemap3.getOrDefault(p_216517_, p_216517_);
      }));
      Schema schema162 = p_14514_.addSchema(3087, SAME_NAMESPACED);
      p_14514_.addFixer(new EntityVariantFix(schema162, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), (p_216519_) -> {
      ...
      p_14514_.addFixer(new CriteriaRenameFix(schema166, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (p_216531_) -> {
         return map.getOrDefault(p_216531_, p_216531_);
      }));
      p_14514_.addFixer(new PoiTypeRemoveFix(schema166, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
      ...
      p_14514_.addFixer(new NamespacedTypeRenameFix(schema182, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
      ...
      p_14514_.addFixer(new RemapChunkStatusFix(schema186, "Remove liquid_carvers and heightmap chunk statuses", createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
      ...
      p_14514_.addFixer(BlockRenameFixWithJigsaw.create(schema197, "Rename grass block to short_grass", unaryoperator1));
