...
public class V3685 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_312739_) {
      ...
      p_312739_.register(map, "minecraft:trident", () -> {
         return abstractArrow(p_312739_);
      });
      p_312739_.register(map, "minecraft:spectral_arrow", () -> {
         return abstractArrow(p_312739_);
      });
      p_312739_.register(map, "minecraft:arrow", () -> {
         return abstractArrow(p_312739_);
      });
      return map;
   }
