...
public class V1470 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_17710_) {
      ...
      p_17710_.register(map, "minecraft:trident", (p_309012_) -> {
         return DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(p_17710_), "Trident", References.ITEM_STACK.in(p_17710_));
      });
      return map;
   }
}