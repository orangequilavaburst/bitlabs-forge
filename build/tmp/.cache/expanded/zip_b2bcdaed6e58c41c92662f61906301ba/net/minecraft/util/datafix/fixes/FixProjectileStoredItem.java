...
public class FixProjectileStoredItem extends DataFix {
   ...
   private static <T> Function<Typed<?>, Typed<?>> fixChoiceCap(String p_312294_, FixProjectileStoredItem.SubFixer<?> p_310164_, Type<?> p_310703_, Type<T> p_312528_) {
      OpticFinder<?> opticfinder = DSL.namedChoice(p_312294_, p_310703_);
      return (p_313205_) -> {
         return p_313205_.updateTyped(opticfinder, p_312528_, (p_312567_) -> {
            return ((FixProjectileStoredItem.SubFixer)p_310164_).fix(p_312567_, p_312528_);
         });
      };
   }

   private static <T> Typed<T> fixArrow(Typed<?> p_312190_, Type<T> p_311775_) {
      return Util.writeAndReadTypedOrThrow(p_312190_, p_311775_, (p_312479_) -> {
         return p_312479_.set("item", createItemStack(p_312479_, getArrowType(p_312479_)));
      });
   }
   ...
   private static <T> Typed<T> fixSpectralArrow(Typed<?> p_311496_, Type<T> p_311551_) {
      return Util.writeAndReadTypedOrThrow(p_311496_, p_311551_, (p_310800_) -> {
         return p_310800_.set("item", createItemStack(p_310800_, "minecraft:spectral_arrow"));
      });
   }

   private static Dynamic<?> createItemStack(Dynamic<?> p_310249_, String p_312956_) {
      return p_310249_.createMap(ImmutableMap.of(p_310249_.createString("id"), p_310249_.createString(p_312956_), p_310249_.createString("Count"), p_310249_.createInt(1)));
   }
