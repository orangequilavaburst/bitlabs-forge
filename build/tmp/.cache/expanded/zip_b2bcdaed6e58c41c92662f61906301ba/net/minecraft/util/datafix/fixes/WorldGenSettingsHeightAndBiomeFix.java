...
public class WorldGenSettingsHeightAndBiomeFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("WorldGenSettingsHeightAndBiomeFix", type, type1, (p_309007_) -> {
         ...
         return p_309007_.update(DSL.remainderFinder(), (p_185205_) -> {
            return p_185205_.remove("has_increased_height_already");
         }).updateTyped(opticfinder, type2, (p_309004_) -> {
            return Util.writeAndReadTypedOrThrow(p_309004_, type2, (p_309010_) -> {
               return p_309010_.update("minecraft:overworld", (p_185194_) -> {
