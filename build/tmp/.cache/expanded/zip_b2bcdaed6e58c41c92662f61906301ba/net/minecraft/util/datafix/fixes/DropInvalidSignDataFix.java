   ...
   private static <T> Dynamic<T> fixText(Dynamic<T> p_299128_) {
      ...
      if (flag) {
         ...
         if (optional.isEmpty()) {
            ...
            return list1.stream().allMatch((p_300495_) -> {
               return p_300495_.equals(dynamic);
            }) ? p_299128_.remove("filtered_messages") : p_299128_.set("filtered_messages", p_299128_.createList(list1.stream()));
         }
      }
   }
