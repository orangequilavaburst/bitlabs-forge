...
public class LevelLegacyWorldGenSettingsFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("LevelLegacyWorldGenSettingsFix", this.getInputSchema().getType(References.LEVEL), (p_311579_) -> {
         return p_311579_.update(DSL.remainderFinder(), (p_309406_) -> {
