...
public class BlockModelGenerators {
   ...
   private void createBrushableBlock(Block p_277651_) {
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(p_277651_).with(PropertyDispatch.property(BlockStateProperties.DUSTED).generate((p_277253_) -> {
         ...
         return Variant.variant().with(VariantProperties.MODEL, ModelTemplates.CUBE_ALL.createWithSuffix(p_277651_, s, (new TextureMapping()).put(TextureSlot.ALL, resourcelocation), this.modelOutput));
      })));
   ...
   static BlockStateGenerator createCustomFence(Block p_248625_, ResourceLocation p_248654_, ResourceLocation p_249827_, ResourceLocation p_248819_, ResourceLocation p_251062_, ResourceLocation p_249076_) {
      return MultiPartGenerator.multiPart(p_248625_).with(Variant.variant().with(VariantProperties.MODEL, p_248654_)).with(Condition.condition().term(BlockStateProperties.NORTH, true), Variant.variant().with(VariantProperties.MODEL, p_249827_).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.EAST, true), Variant.variant().with(VariantProperties.MODEL, p_248819_).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.SOUTH, true), Variant.variant().with(VariantProperties.MODEL, p_251062_).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.WEST, true), Variant.variant().with(VariantProperties.MODEL, p_249076_).with(VariantProperties.UV_LOCK, false));
   }
   ...
   void createDoor(Block p_124897_) {
      ...
      this.blockStateOutput.accept(createDoor(p_124897_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5, resourcelocation6, resourcelocation7));
   }

   private void copyDoorModel(Block p_311336_, Block p_309682_) {
      ResourceLocation resourcelocation = ModelTemplates.DOOR_BOTTOM_LEFT.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation1 = ModelTemplates.DOOR_BOTTOM_LEFT_OPEN.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation2 = ModelTemplates.DOOR_BOTTOM_RIGHT.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation3 = ModelTemplates.DOOR_BOTTOM_RIGHT_OPEN.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation4 = ModelTemplates.DOOR_TOP_LEFT.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation5 = ModelTemplates.DOOR_TOP_LEFT_OPEN.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation6 = ModelTemplates.DOOR_TOP_RIGHT.getDefaultModelLocation(p_311336_);
      ResourceLocation resourcelocation7 = ModelTemplates.DOOR_TOP_RIGHT_OPEN.getDefaultModelLocation(p_311336_);
      this.delegateItemModel(p_309682_, ModelLocationUtils.getModelLocation(p_311336_.asItem()));
      this.blockStateOutput.accept(createDoor(p_309682_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5, resourcelocation6, resourcelocation7));
   }
   ...
   private void copyTrapdoorModel(Block p_312446_, Block p_310485_) {
      ResourceLocation resourcelocation = ModelTemplates.TRAPDOOR_TOP.getDefaultModelLocation(p_312446_);
      ResourceLocation resourcelocation1 = ModelTemplates.TRAPDOOR_BOTTOM.getDefaultModelLocation(p_312446_);
      ResourceLocation resourcelocation2 = ModelTemplates.TRAPDOOR_OPEN.getDefaultModelLocation(p_312446_);
      this.delegateItemModel(p_310485_, ModelLocationUtils.getModelLocation(p_312446_.asItem()));
      this.blockStateOutput.accept(createTrapdoor(p_310485_, resourcelocation, resourcelocation1, resourcelocation2));
   }
   ...
   private void createPitcherCrop() {
      ...
      this.createSimpleFlatItemModel(block.asItem());
      PropertyDispatch propertydispatch = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF).generate((p_277255_, p_277256_) -> {
         Variant variant;
         switch (p_277256_) {
            case UPPER:
               variant = Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_top_stage_" + p_277255_));
               break;
            case LOWER:
               variant = Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_bottom_stage_" + p_277255_));
               break;
            default:
   ...
   private void createCrafterBlock() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CRAFTER).with(PropertyDispatch.property(BlockStateProperties.ORIENTATION).generate((p_236301_) -> {
         return this.applyRotation(p_236301_, Variant.variant());
      })).with(PropertyDispatch.properties(BlockStateProperties.TRIGGERED, CrafterBlock.CRAFTING).select(false, false, Variant.variant().with(VariantProperties.MODEL, resourcelocation)).select(true, true, Variant.variant().with(VariantProperties.MODEL, resourcelocation3)).select(true, false, Variant.variant().with(VariantProperties.MODEL, resourcelocation1)).select(false, true, Variant.variant().with(VariantProperties.MODEL, resourcelocation2))));
   }
   ...
   private void createCopperBulb(Block p_311077_) {
      ResourceLocation resourcelocation = ModelTemplates.CUBE_ALL.create(p_311077_, TextureMapping.cube(p_311077_), this.modelOutput);
      ResourceLocation resourcelocation1 = this.createSuffixedVariant(p_311077_, "_powered", ModelTemplates.CUBE_ALL, TextureMapping::cube);
      ResourceLocation resourcelocation2 = this.createSuffixedVariant(p_311077_, "_lit", ModelTemplates.CUBE_ALL, TextureMapping::cube);
      ResourceLocation resourcelocation3 = this.createSuffixedVariant(p_311077_, "_lit_powered", ModelTemplates.CUBE_ALL, TextureMapping::cube);
      this.blockStateOutput.accept(this.createCopperBulb(p_311077_, resourcelocation, resourcelocation2, resourcelocation1, resourcelocation3));
   }

   private BlockStateGenerator createCopperBulb(Block p_309677_, ResourceLocation p_309526_, ResourceLocation p_310659_, ResourceLocation p_310780_, ResourceLocation p_309762_) {
      return MultiVariantGenerator.multiVariant(p_309677_).with(PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED).generate((p_308505_, p_308506_) -> {
         return p_308505_ ? Variant.variant().with(VariantProperties.MODEL, p_308506_ ? p_309762_ : p_310659_) : Variant.variant().with(VariantProperties.MODEL, p_308506_ ? p_310780_ : p_309526_);
      }));
   }

   private void copyCopperBulbModel(Block p_310234_, Block p_312487_) {
      ResourceLocation resourcelocation = ModelLocationUtils.getModelLocation(p_310234_);
      ResourceLocation resourcelocation1 = ModelLocationUtils.getModelLocation(p_310234_, "_powered");
      ResourceLocation resourcelocation2 = ModelLocationUtils.getModelLocation(p_310234_, "_lit");
      ResourceLocation resourcelocation3 = ModelLocationUtils.getModelLocation(p_310234_, "_lit_powered");
      this.delegateItemModel(p_312487_, ModelLocationUtils.getModelLocation(p_310234_.asItem()));
      this.blockStateOutput.accept(this.createCopperBulb(p_312487_, resourcelocation, resourcelocation2, resourcelocation1, resourcelocation3));
   }
   ...
   private void createTrialSpawner() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.TRIAL_SPAWNER_STATE).generate((p_308514_) -> {
         Variant variant;
         switch (p_308514_) {
            case INACTIVE:
            case COOLDOWN:
   ...
   private void createSculkSensor() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SCULK_SENSOR).with(PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE).generate((p_284650_) -> {
         return Variant.variant().with(VariantProperties.MODEL, p_284650_ != SculkSensorPhase.ACTIVE && p_284650_ != SculkSensorPhase.COOLDOWN ? resourcelocation : resourcelocation1);
      })));
   }
   ...
   private void createCalibratedSculkSensor() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CALIBRATED_SCULK_SENSOR).with(PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE).generate((p_284647_) -> {
         return Variant.variant().with(VariantProperties.MODEL, p_284647_ != SculkSensorPhase.ACTIVE && p_284647_ != SculkSensorPhase.COOLDOWN ? resourcelocation : resourcelocation1);
   ...
   private void createSnifferEgg() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SNIFFER_EGG).with(PropertyDispatch.property(SnifferEggBlock.HATCH).generate((p_277261_) -> {
         return Variant.variant().with(VariantProperties.MODEL, function.apply(p_277261_));
      })));
   }
   ...
   private void createMultiface(Block p_176086_) {
      ...
      for(Pair<BooleanProperty, Function<ResourceLocation, Variant>> pair : MULTIFACE_GENERATOR) {
         ...
         if (p_176086_.defaultBlockState().hasProperty(booleanproperty)) {
   ...
   private void createChiseledBookshelf() {
      ...
      Map.of(Direction.NORTH, VariantProperties.Rotation.R0, Direction.EAST, VariantProperties.Rotation.R90, Direction.SOUTH, VariantProperties.Rotation.R180, Direction.WEST, VariantProperties.Rotation.R270).forEach((p_262541_, p_262542_) -> {
         ...
         this.addSlotStateAndRotationVariants(multipartgenerator, condition$terminalcondition, p_262542_);
      });
      this.blockStateOutput.accept(multipartgenerator);
   ...
   private void addBookSlotModel(MultiPartGenerator p_261839_, Condition.TerminalCondition p_261634_, VariantProperties.Rotation p_262044_, BooleanProperty p_262163_, ModelTemplate p_261986_, boolean p_261790_) {
      ...
      ResourceLocation resourcelocation = CHISELED_BOOKSHELF_SLOT_MODEL_CACHE.computeIfAbsent(blockmodelgenerators$bookslotmodelcachekey, (p_261415_) -> {
         return p_261986_.createWithSuffix(Blocks.CHISELED_BOOKSHELF, s, texturemapping, this.modelOutput);
      });
   ...
   private void createJigsaw() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.JIGSAW, Variant.variant().with(VariantProperties.MODEL, resourcelocation4)).with(PropertyDispatch.property(BlockStateProperties.ORIENTATION).generate((p_308500_) -> {
         return this.applyRotation(p_308500_, Variant.variant());
      })));
   }
   ...
   class BlockFamilyProvider {
      ...
      public BlockModelGenerators.BlockFamilyProvider donateModelTo(Block p_309456_, Block p_312030_) {
         ResourceLocation resourcelocation = ModelLocationUtils.getModelLocation(p_309456_);
         BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(p_312030_, resourcelocation));
         BlockModelGenerators.this.delegateItemModel(p_312030_, resourcelocation);
         this.skipGeneratingModelsFor.add(p_312030_);
         return this;
      }
      ...
      public BlockModelGenerators.BlockFamilyProvider customFence(Block p_250333_) {
         TextureMapping texturemapping = TextureMapping.customParticle(p_250333_);
         ResourceLocation resourcelocation = ModelTemplates.CUSTOM_FENCE_POST.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation1 = ModelTemplates.CUSTOM_FENCE_SIDE_NORTH.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation2 = ModelTemplates.CUSTOM_FENCE_SIDE_EAST.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation3 = ModelTemplates.CUSTOM_FENCE_SIDE_SOUTH.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation4 = ModelTemplates.CUSTOM_FENCE_SIDE_WEST.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createCustomFence(p_250333_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4));
         ResourceLocation resourcelocation5 = ModelTemplates.CUSTOM_FENCE_INVENTORY.create(p_250333_, texturemapping, BlockModelGenerators.this.modelOutput);
         BlockModelGenerators.this.delegateItemModel(p_250333_, resourcelocation5);
         return this;
      }
      ...
      public BlockModelGenerators.BlockFamilyProvider customFenceGate(Block p_248640_) {
         TextureMapping texturemapping = TextureMapping.customParticle(p_248640_);
         ResourceLocation resourcelocation = ModelTemplates.CUSTOM_FENCE_GATE_OPEN.create(p_248640_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation1 = ModelTemplates.CUSTOM_FENCE_GATE_CLOSED.create(p_248640_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation2 = ModelTemplates.CUSTOM_FENCE_GATE_WALL_OPEN.create(p_248640_, texturemapping, BlockModelGenerators.this.modelOutput);
         ResourceLocation resourcelocation3 = ModelTemplates.CUSTOM_FENCE_GATE_WALL_CLOSED.create(p_248640_, texturemapping, BlockModelGenerators.this.modelOutput);
         BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(p_248640_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, false));
         return this;
      }
      ...
      public BlockModelGenerators.BlockFamilyProvider fenceGate(Block p_125050_) {
         ...
         BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(p_125050_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, true));
         return this;
      }
      ...
      private BlockModelGenerators.BlockFamilyProvider fullBlockVariant(Block p_176272_) {
         ...
         ResourceLocation resourcelocation = texturedmodel.create(p_176272_, BlockModelGenerators.this.modelOutput);
         BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(p_176272_, resourcelocation));
         return this;
      }
      ...
      public BlockModelGenerators.BlockFamilyProvider generateFor(BlockFamily p_176260_) {
         ...
         p_176260_.getVariants().forEach((p_308515_, p_308516_) -> {
            if (!this.skipGeneratingModelsFor.contains(p_308516_)) {
               BiConsumer<BlockModelGenerators.BlockFamilyProvider, Block> biconsumer = BlockModelGenerators.SHAPE_CONSUMERS.get(p_308515_);
               if (biconsumer != null) {
                  biconsumer.accept(this, p_308516_);
               }
