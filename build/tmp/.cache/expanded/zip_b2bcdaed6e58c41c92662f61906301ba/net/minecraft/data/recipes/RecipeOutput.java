...
public interface RecipeOutput {
   default void accept(ResourceLocation p_310578_, Recipe<?> p_312265_, @Nullable AdvancementHolder p_310407_) {
       if (p_310407_ == null)
           ...
           var json = net.minecraft.Util.getOrThrow(Advancement.CODEC.encodeStart(com.mojang.serialization.JsonOps.INSTANCE, p_310407_.value()), IllegalStateException::new);
