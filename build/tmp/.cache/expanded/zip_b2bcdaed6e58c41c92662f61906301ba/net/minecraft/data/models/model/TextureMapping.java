...
public class TextureMapping {
   ...
   public static TextureMapping trialSpawner(Block p_313123_, String p_310566_, String p_310636_) {
      return (new TextureMapping()).put(TextureSlot.SIDE, getBlockTexture(p_313123_, p_310566_)).put(TextureSlot.TOP, getBlockTexture(p_313123_, p_310636_)).put(TextureSlot.BOTTOM, getBlockTexture(p_313123_, "_bottom"));
   }
