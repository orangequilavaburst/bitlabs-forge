...
public abstract class RecipeProvider implements DataProvider {
   ...
   protected CompletableFuture<?> buildAdvancement(CachedOutput p_253674_, AdvancementHolder p_297687_) {
      return DataProvider.saveStable(p_253674_, Advancement.CODEC, p_297687_.value(), this.advancementPathProvider.json(p_297687_.id()));
   }
   ...
   protected static void generateForEnabledBlockFamilies(RecipeOutput p_300618_, FeatureFlagSet p_251836_) {
      BlockFamilies.getAllFamilies().filter(BlockFamily::shouldGenerateRecipe).forEach((p_308528_) -> {
         generateRecipes(p_300618_, p_308528_, p_251836_);
      });
   }
   ...
   protected static void oneToOneConversionRecipe(RecipeOutput p_301230_, ItemLike p_176558_, ItemLike p_176559_, @Nullable String p_176560_, int p_176561_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, p_176558_, p_176561_).requires(p_176559_).group(p_176560_).unlockedBy(getHasName(p_176559_), has(p_176559_)).save(p_301230_, getConversionRecipeName(p_176558_, p_176559_));
   }
   ...
   private static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput p_297621_, RecipeSerializer<T> p_251817_, AbstractCookingRecipe.Factory<T> p_312098_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
      for(ItemLike itemlike : p_249619_) {
         SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_, p_312098_).group(p_251450_).unlockedBy(getHasName(itemlike), has(itemlike)).save(p_297621_, getItemName(p_250066_) + p_249236_ + "_" + getItemName(itemlike));
      }

   }

   protected static void netheriteSmithing(RecipeOutput p_298409_, Item p_250046_, RecipeCategory p_248986_, Item p_250389_) {
      SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.of(p_250046_), Ingredient.of(Items.NETHERITE_INGOT), p_248986_, p_250389_).unlocks("has_netherite_ingot", has(Items.NETHERITE_INGOT)).save(p_298409_, getItemName(p_250389_) + "_smithing");
   }

   protected static void trimSmithing(RecipeOutput p_297574_, Item p_285461_, ResourceLocation p_285044_) {
      SmithingTrimRecipeBuilder.smithingTrim(Ingredient.of(p_285461_), Ingredient.of(ItemTags.TRIMMABLE_ARMOR), Ingredient.of(ItemTags.TRIM_MATERIALS), RecipeCategory.MISC).unlocks("has_smithing_trim_template", has(p_285461_)).save(p_297574_, p_285044_);
   }
   ...
   protected static void twoByTwoPacker(RecipeOutput p_297675_, RecipeCategory p_250881_, ItemLike p_252184_, ItemLike p_249710_) {
      ShapedRecipeBuilder.shaped(p_250881_, p_252184_, 1).define('#', p_249710_).pattern("##").pattern("##").unlockedBy(getHasName(p_249710_), has(p_249710_)).save(p_297675_);
   }
   ...
   protected static void planksFromLog(RecipeOutput p_298877_, ItemLike p_259052_, TagKey<Item> p_259045_, int p_259471_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_259052_, p_259471_).requires(p_259045_).group("planks").unlockedBy("has_log", has(p_259045_)).save(p_298877_);
   }

   protected static void planksFromLogs(RecipeOutput p_298139_, ItemLike p_259193_, TagKey<Item> p_259818_, int p_259807_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_259193_, p_259807_).requires(p_259818_).group("planks").unlockedBy("has_logs", has(p_259818_)).save(p_298139_);
   }

   protected static void woodFromLogs(RecipeOutput p_298359_, ItemLike p_126004_, ItemLike p_126005_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126004_, 3).define('#', p_126005_).pattern("##").pattern("##").group("bark").unlockedBy("has_log", has(p_126005_)).save(p_298359_);
   }

   protected static void woodenBoat(RecipeOutput p_300366_, ItemLike p_126023_, ItemLike p_126024_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.TRANSPORTATION, p_126023_).define('#', p_126024_).pattern("# #").pattern("###").group("boat").unlockedBy("in_water", insideOf(Blocks.WATER)).save(p_300366_);
   }

   protected static void chestBoat(RecipeOutput p_300411_, ItemLike p_236373_, ItemLike p_236374_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.TRANSPORTATION, p_236373_).requires(Blocks.CHEST).requires(p_236374_).group("chest_boat").unlockedBy("has_boat", has(ItemTags.BOATS)).save(p_300411_);
   }
   ...
   protected static void pressurePlate(RecipeOutput p_299733_, ItemLike p_176692_, ItemLike p_176693_) {
      pressurePlateBuilder(RecipeCategory.REDSTONE, p_176692_, Ingredient.of(p_176693_)).unlockedBy(getHasName(p_176693_), has(p_176693_)).save(p_299733_);
   }
   ...
   protected static void hangingSign(RecipeOutput p_300811_, ItemLike p_252355_, ItemLike p_250437_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_252355_, 6).group("hanging_sign").define('#', p_250437_).define('X', Items.CHAIN).pattern("X X").pattern("###").pattern("###").unlockedBy("has_stripped_logs", has(p_250437_)).save(p_300811_);
   }
   ...
   protected static void colorBlockWithDye(RecipeOutput p_297350_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) {
      for(int i = 0; i < p_289675_.size(); ++i) {
         ...
         }).map(ItemStack::new))).group(p_289641_).unlockedBy("has_needed_dye", has(item)).save(p_297350_, "dye_" + getItemName(item1));
      }

   }

   protected static void carpet(RecipeOutput p_298709_, ItemLike p_176718_, ItemLike p_176719_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_176718_, 3).define('#', p_176719_).pattern("##").group("carpet").unlockedBy(getHasName(p_176719_), has(p_176719_)).save(p_298709_);
   }

   protected static void bedFromPlanksAndWool(RecipeOutput p_300515_, ItemLike p_126075_, ItemLike p_126076_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126075_).define('#', p_126076_).define('X', ItemTags.PLANKS).pattern("###").pattern("XXX").group("bed").unlockedBy(getHasName(p_126076_), has(p_126076_)).save(p_300515_);
   }

   protected static void banner(RecipeOutput p_300693_, ItemLike p_126083_, ItemLike p_126084_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126083_).define('#', p_126084_).define('|', Items.STICK).pattern("###").pattern("###").pattern(" | ").group("banner").unlockedBy(getHasName(p_126084_), has(p_126084_)).save(p_300693_);
   }

   protected static void stainedGlassFromGlassAndDye(RecipeOutput p_297360_, ItemLike p_126087_, ItemLike p_126088_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126087_, 8).define('#', Blocks.GLASS).define('X', p_126088_).pattern("###").pattern("#X#").pattern("###").group("stained_glass").unlockedBy("has_glass", has(Blocks.GLASS)).save(p_297360_);
   }

   protected static void stainedGlassPaneFromStainedGlass(RecipeOutput p_300949_, ItemLike p_126091_, ItemLike p_126092_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126091_, 16).define('#', p_126092_).pattern("###").pattern("###").group("stained_glass_pane").unlockedBy("has_glass", has(p_126092_)).save(p_300949_);
   }

   protected static void stainedGlassPaneFromGlassPaneAndDye(RecipeOutput p_298776_, ItemLike p_126095_, ItemLike p_126096_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126095_, 8).define('#', Blocks.GLASS_PANE).define('$', p_126096_).pattern("###").pattern("#$#").pattern("###").group("stained_glass_pane").unlockedBy("has_glass_pane", has(Blocks.GLASS_PANE)).unlockedBy(getHasName(p_126096_), has(p_126096_)).save(p_298776_, getConversionRecipeName(p_126095_, Blocks.GLASS_PANE));
   }

   protected static void coloredTerracottaFromTerracottaAndDye(RecipeOutput p_297522_, ItemLike p_126099_, ItemLike p_126100_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126099_, 8).define('#', Blocks.TERRACOTTA).define('X', p_126100_).pattern("###").pattern("#X#").pattern("###").group("stained_terracotta").unlockedBy("has_terracotta", has(Blocks.TERRACOTTA)).save(p_297522_);
   }

   protected static void concretePowder(RecipeOutput p_300890_, ItemLike p_126103_, ItemLike p_126104_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_126103_, 8).requires(p_126104_).requires(Blocks.SAND, 4).requires(Blocks.GRAVEL, 4).group("concrete_powder").unlockedBy("has_sand", has(Blocks.SAND)).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(p_300890_);
   }

   protected static void candle(RecipeOutput p_299296_, ItemLike p_176544_, ItemLike p_176545_) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, p_176544_).requires(Blocks.CANDLE).requires(p_176545_).group("dyed_candle").unlockedBy(getHasName(p_176545_), has(p_176545_)).save(p_299296_);
   }
   ...
   protected static void mosaicBuilder(RecipeOutput p_298750_, RecipeCategory p_248788_, ItemLike p_251925_, ItemLike p_252242_) {
      ShapedRecipeBuilder.shaped(p_248788_, p_251925_).define('#', p_252242_).pattern("#").pattern("#").unlockedBy(getHasName(p_252242_), has(p_252242_)).save(p_298750_);
   }
   ...
   protected static void stonecutterResultFromBase(RecipeOutput p_300991_, RecipeCategory p_248911_, ItemLike p_251265_, ItemLike p_250033_, int p_301035_) {
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(p_250033_), p_248911_, p_251265_, p_301035_).unlockedBy(getHasName(p_250033_), has(p_250033_)).save(p_300991_, getConversionRecipeName(p_251265_, p_250033_) + "_stonecutting");
   }

   private static void smeltingResultFromBase(RecipeOutput p_298757_, ItemLike p_176741_, ItemLike p_176742_) {
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(p_176742_), RecipeCategory.BUILDING_BLOCKS, p_176741_, 0.1F, 200).unlockedBy(getHasName(p_176742_), has(p_176742_)).save(p_298757_);
   }
   ...
   protected static void nineBlockStorageRecipes(RecipeOutput p_298715_, RecipeCategory p_251203_, ItemLike p_251689_, RecipeCategory p_251376_, ItemLike p_248771_) {
      nineBlockStorageRecipes(p_298715_, p_251203_, p_251689_, p_251376_, p_248771_, getSimpleRecipeName(p_248771_), (String)null, getSimpleRecipeName(p_251689_), (String)null);
   }
   ...
   protected static void nineBlockStorageRecipesWithCustomPacking(RecipeOutput p_300453_, RecipeCategory p_250885_, ItemLike p_251651_, RecipeCategory p_250874_, ItemLike p_248576_, String p_250171_, String p_249386_) {
      nineBlockStorageRecipes(p_300453_, p_250885_, p_251651_, p_250874_, p_248576_, p_250171_, p_249386_, getSimpleRecipeName(p_251651_), (String)null);
   }
   ...
   protected static void nineBlockStorageRecipesRecipesWithCustomUnpacking(RecipeOutput p_298590_, RecipeCategory p_248979_, ItemLike p_249101_, RecipeCategory p_252036_, ItemLike p_250886_, String p_248768_, String p_250847_) {
      nineBlockStorageRecipes(p_298590_, p_248979_, p_249101_, p_252036_, p_250886_, getSimpleRecipeName(p_250886_), (String)null, p_248768_, p_250847_);
   }
   ...
   private static void nineBlockStorageRecipes(RecipeOutput p_298159_, RecipeCategory p_250083_, ItemLike p_250042_, RecipeCategory p_248977_, ItemLike p_251911_, String p_250475_, @Nullable String p_248641_, String p_252237_, @Nullable String p_250414_) {
      ShapelessRecipeBuilder.shapeless(p_250083_, p_250042_, 9).requires(p_251911_).group(p_250414_).unlockedBy(getHasName(p_251911_), has(p_251911_)).save(p_298159_, new ResourceLocation(p_252237_));
      ShapedRecipeBuilder.shaped(p_248977_, p_251911_).define('#', p_250042_).pattern("###").pattern("###").pattern("###").group(p_248641_).unlockedBy(getHasName(p_250042_), has(p_250042_)).save(p_298159_, new ResourceLocation(p_250475_));
   }

   protected static void copySmithingTemplate(RecipeOutput p_299385_, ItemLike p_267133_, TagKey<Item> p_298808_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.MISC, p_267133_, 2).define('#', Items.DIAMOND).define('C', p_298808_).define('S', p_267133_).pattern("#S#").pattern("#C#").pattern("###").unlockedBy(getHasName(p_267133_), has(p_267133_)).save(p_299385_);
   }

   protected static void copySmithingTemplate(RecipeOutput p_300831_, ItemLike p_266974_, ItemLike p_298586_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.MISC, p_266974_, 2).define('#', Items.DIAMOND).define('C', p_298586_).define('S', p_266974_).pattern("#S#").pattern("#C#").pattern("###").unlockedBy(getHasName(p_266974_), has(p_266974_)).save(p_300831_);
   }
   ...
   private static <T extends AbstractCookingRecipe> void simpleCookingRecipe(RecipeOutput p_301359_, String p_249709_, RecipeSerializer<T> p_251876_, AbstractCookingRecipe.Factory<T> p_311509_, int p_249258_, ItemLike p_250669_, ItemLike p_250224_, float p_252138_) {
      SimpleCookingRecipeBuilder.generic(Ingredient.of(p_250669_), RecipeCategory.FOOD, p_250224_, p_252138_, p_249258_, p_251876_, p_311509_).unlockedBy(getHasName(p_250669_), has(p_250669_)).save(p_301359_, getItemName(p_250224_) + "_from_" + p_249709_);
   }

   protected static void waxRecipes(RecipeOutput p_298400_, FeatureFlagSet p_312821_) {
      HoneycombItem.WAXABLES.get().forEach((p_308519_, p_308520_) -> {
         if (p_308520_.requiredFeatures().isSubsetOf(p_312821_)) {
            ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_308520_).requires(p_308519_).requires(Items.HONEYCOMB).group(getItemName(p_308520_)).unlockedBy(getHasName(p_308519_), has(p_308519_)).save(p_298400_, getConversionRecipeName(p_308520_, Items.HONEYCOMB));
         }
      });
   }

   protected static void grate(RecipeOutput p_311070_, Block p_309854_, Block p_310802_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_309854_, 4).define('M', p_310802_).pattern(" M ").pattern("M M").pattern(" M ").unlockedBy(getHasName(p_310802_), has(p_310802_)).save(p_311070_);
   }

   protected static void copperBulb(RecipeOutput p_310731_, Block p_312293_, Block p_312258_) {
      ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, p_312293_, 4).define('C', p_312258_).define('R', Items.REDSTONE).define('B', Items.BLAZE_ROD).pattern(" C ").pattern("CBC").pattern(" R ").unlockedBy(getHasName(p_312258_), has(p_312258_)).save(p_310731_);
   }

   protected static void generateRecipes(RecipeOutput p_299904_, BlockFamily p_176582_, FeatureFlagSet p_312313_) {
      p_176582_.getVariants().forEach((p_308524_, p_308525_) -> {
         if (p_308525_.requiredFeatures().isSubsetOf(p_312313_)) {
            ...
            if (bifunction != null) {
               ...
               p_176582_.getRecipeGroupPrefix().ifPresent((p_296361_) -> {
                  recipebuilder.group(p_296361_ + (p_308524_ == BlockFamily.Variant.CUT ? "" : "_" + p_308524_.getRecipeGroup()));
               });
