...
public final class UUIDUtil {
   ...
   public static Codec<UUID> AUTHLIB_CODEC = Codec.either(CODEC, Codec.STRING.comapFlatMap((p_296331_) -> {
      try {
         return DataResult.success(UndashedUuid.fromStringLenient(p_296331_), Lifecycle.stable());
      } catch (IllegalArgumentException illegalargumentexception) {
         return DataResult.error(() -> {
            return "Invalid UUID " + p_296331_ + ": " + illegalargumentexception.getMessage();
         });
      }
   }, UndashedUuid::toString)).xmap((p_308466_) -> {
      return p_308466_.map((p_253361_) -> {
         return p_253361_;
      }, (p_308465_) -> {
         return p_308465_;
      });
   }, Either::right);
   public static Codec<UUID> LENIENT_CODEC = Codec.either(CODEC, STRING_CODEC).xmap((p_253364_) -> {
      return p_253364_.map((p_308464_) -> {
         return p_308464_;
      }, (p_253362_) -> {
         return p_253362_;
      });
