...
public class ParticleTypes {
   ...
   public static final ParticleType<BlockParticleOption> BLOCK_MARKER = register("block_marker", true, BlockParticleOption.DESERIALIZER, BlockParticleOption::codec);
   ...
   public static final ParticleType<DustParticleOptions> DUST = register("dust", false, DustParticleOptions.DESERIALIZER, (p_123819_) -> {
      return DustParticleOptions.CODEC;
   });
   public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, (p_175841_) -> {
   ...
   public static final ParticleType<BlockParticleOption> FALLING_DUST = register("falling_dust", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::codec);
   ...
   public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, (p_175839_) -> {
   ...
   public static final ParticleType<VibrationParticleOption> VIBRATION = register("vibration", true, VibrationParticleOption.DESERIALIZER, (p_235911_) -> {
   ...
   public static final ParticleType<ShriekParticleOption> SHRIEK = register("shriek", false, ShriekParticleOption.DESERIALIZER, (p_235904_) -> {
   ...
   private static <T extends ParticleOptions> ParticleType<T> register(String p_235906_, boolean p_235907_, ParticleOptions.Deserializer<T> p_235908_, final Function<ParticleType<T>, Codec<T>> p_235909_) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, p_235906_, new ParticleType<T>(p_235907_, p_235908_) {
