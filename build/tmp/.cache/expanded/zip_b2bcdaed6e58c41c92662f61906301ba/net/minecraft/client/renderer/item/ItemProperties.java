...
public class ItemProperties {
   ...
   static {
      ...
      ClampedItemPropertyFunction clampeditempropertyfunction = (p_308299_, p_308300_, p_308301_, p_308302_) -> {
         if (!p_308299_.is(ItemTags.TRIMMABLE_ARMOR)) {
            return Float.NEGATIVE_INFINITY;
         } else {
            return p_308300_ == null ? 0.0F : ArmorTrim.getTrim(p_308300_.registryAccess(), p_308299_, true).map(ArmorTrim::material).map(Holder::value).map(TrimMaterial::itemModelIndex).orElse(0.0F);
         }
      };
