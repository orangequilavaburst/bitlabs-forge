...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
   ...
   protected void createFooter() {
      this.addRenderableWidget(Button.builder(Component.translatable("options.accessibility.link"), ConfirmLinkScreen.confirmLink(this, "https://aka.ms/MinecraftJavaAccessibility")).bounds(this.width / 2 - 155, this.height - 27, 150, 20).build());
