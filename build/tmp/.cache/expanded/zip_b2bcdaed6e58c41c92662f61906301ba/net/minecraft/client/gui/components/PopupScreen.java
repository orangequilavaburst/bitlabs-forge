...
public class PopupScreen extends Screen {
   ...
   protected void init() {
      ...
      this.layout.visitWidgets((p_309857_) -> {
         AbstractWidget abstractwidget = this.addRenderableWidget(p_309857_);
      });
   ...
   private LinearLayout buildButtonRow() {
      ...
      for(PopupScreen.ButtonOption popupscreen$buttonoption : this.buttons) {
         linearlayout.addChild(Button.builder(popupscreen$buttonoption.message(), (p_310515_) -> {
            popupscreen$buttonoption.action().accept(this);
         }).width(j).build());
      }
   ...
   public void renderBackground(GuiGraphics p_312654_, int p_312824_, int p_310533_, float p_313128_) {
      ...
      p_312654_.blitSprite(BACKGROUND_SPRITE, this.layout.getX() - 18, this.layout.getY() - 18, this.layout.getWidth() + 36, this.layout.getHeight() + 36);
   }
