...
public class Gui {
   ...
   protected static final Comparator<PlayerScoreEntry> SCORE_DISPLAY_ORDER = Comparator.comparing(PlayerScoreEntry::value).reversed().thenComparing(PlayerScoreEntry::owner, String.CASE_INSENSITIVE_ORDER);
   ...
   public void displayScoreboardSidebar(GuiGraphics p_282008_, Objective p_283455_) {
      ...
      DisplayEntry[] agui$1displayentry = scoreboard.listPlayerScores(p_283455_).stream().filter((p_308174_) -> {
         return !p_308174_.isHidden();
      }).sorted(SCORE_DISPLAY_ORDER).limit(15L).map((p_308178_) -> {
   ...
   protected void renderHearts(GuiGraphics p_282497_, Player p_168690_, int p_168691_, int p_168692_, int p_168693_, int p_168694_, float p_168695_, int p_168696_, int p_168697_, int p_168698_, boolean p_168699_) {
      ...
      int i = Mth.ceil((double)p_168695_ / 2.0D);
      int j = Mth.ceil((double)p_168698_ / 2.0D);
      int k = i * 2;
