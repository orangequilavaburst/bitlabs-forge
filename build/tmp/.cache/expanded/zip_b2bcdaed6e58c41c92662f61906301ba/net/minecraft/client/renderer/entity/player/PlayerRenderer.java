   ...
   protected void renderNameTag(AbstractClientPlayer p_117808_, Component p_117809_, PoseStack p_117810_, MultiBufferSource p_117811_, int p_117812_) {
      ...
      if (d0 < 100.0D) {
         ...
         if (objective != null) {
            ...
            super.renderNameTag(p_117808_, Component.empty().append(component).append(CommonComponents.SPACE).append(objective.getDisplayName()), p_117810_, p_117811_, p_117812_);
