...
public class HumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
   ...
   private void poseBlockingArm(ModelPart p_312070_, boolean p_311335_) {
      p_312070_.xRot = p_312070_.xRot * 0.5F - 0.9424779F + Mth.clamp(this.head.xRot, -1.3962634F, 0.43633232F);
      p_312070_.yRot = (p_311335_ ? -30.0F : 30.0F) * ((float)Math.PI / 180F) + Mth.clamp(this.head.yRot, (-(float)Math.PI / 6F), ((float)Math.PI / 6F));
   }
