...
public class TelemetryEventWidget extends AbstractScrollWidget {
   ...
   static class ContentBuilder {
      ...
      public void addLine(Font p_261894_, Component p_261816_, int p_261721_) {
         this.layout.addChild((new MultiLineTextWidget(p_261816_, p_261894_)).setMaxWidth(this.width), (p_300900_) -> {
            p_300900_.paddingBottom(p_261721_);
         });
         this.narration.append(p_261816_).append("\n");
      }

      public void addHeader(Font p_261496_, Component p_261670_) {
         this.layout.addChild((new MultiLineTextWidget(p_261670_, p_261496_)).setMaxWidth(this.width - 64).setCentered(true), (p_298721_) -> {
            p_298721_.alignHorizontallyCenter().paddingHorizontal(32);
         });
