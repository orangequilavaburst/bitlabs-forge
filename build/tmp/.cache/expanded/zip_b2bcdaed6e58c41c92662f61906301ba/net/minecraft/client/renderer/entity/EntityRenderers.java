...
public class EntityRenderers {
   ...
   private static final Map<PlayerSkin.Model, EntityRendererProvider<AbstractClientPlayer>> PLAYER_PROVIDERS = Map.of(PlayerSkin.Model.WIDE, (p_174098_) -> {
   ...
   public static Map<EntityType<?>, EntityRenderer<?>> createEntityRenderers(EntityRendererProvider.Context p_174050_) {
      ...
      PROVIDERS.forEach((p_258154_, p_258155_) -> {
         try {
            builder.put(p_258154_, p_258155_.create(p_174050_));
         } catch (Exception exception) {
            throw new IllegalArgumentException("Failed to create model for " + BuiltInRegistries.ENTITY_TYPE.getKey(p_258154_), exception);
         }
      });
   ...
   public static Map<PlayerSkin.Model, EntityRenderer<? extends Player>> createPlayerRenderers(EntityRendererProvider.Context p_174052_) {
      ...
      PLAYER_PROVIDERS.forEach((p_298101_, p_234608_) -> {
         try {
            builder.put(p_298101_, p_234608_.create(p_174052_));
         } catch (Exception exception) {
            throw new IllegalArgumentException("Failed to create player model for " + p_298101_, exception);
         }
      });
      return builder.build();
   }
   ...
   static {
      ...
      register(EntityType.BOAT, (p_174094_) -> {
         return new BoatRenderer(p_174094_, false);
      });
      register(EntityType.BREEZE, BreezeRenderer::new);
      register(EntityType.CAT, CatRenderer::new);
      register(EntityType.CAMEL, (p_247942_) -> {
         return new CamelRenderer(p_247942_, ModelLayers.CAMEL);
      });
      register(EntityType.CAVE_SPIDER, CaveSpiderRenderer::new);
      register(EntityType.CHEST_BOAT, (p_174092_) -> {
         return new BoatRenderer(p_174092_, true);
      });
      register(EntityType.CHEST_MINECART, (p_174090_) -> {
         return new MinecartRenderer<>(p_174090_, ModelLayers.CHEST_MINECART);
      });
      register(EntityType.CHICKEN, ChickenRenderer::new);
      register(EntityType.COD, CodRenderer::new);
      register(EntityType.COMMAND_BLOCK_MINECART, (p_174088_) -> {
         return new MinecartRenderer<>(p_174088_, ModelLayers.COMMAND_BLOCK_MINECART);
      });
      ...
      register(EntityType.DONKEY, (p_174086_) -> {
         return new ChestedHorseRenderer<>(p_174086_, 0.87F, ModelLayers.DONKEY);
      });
      ...
      register(EntityType.EYE_OF_ENDER, (p_174084_) -> {
         return new ThrownItemRenderer<>(p_174084_, 1.0F, true);
      });
      register(EntityType.FALLING_BLOCK, FallingBlockRenderer::new);
      register(EntityType.FIREBALL, (p_174082_) -> {
      ...
      register(EntityType.FURNACE_MINECART, (p_174080_) -> {
         return new MinecartRenderer<>(p_174080_, ModelLayers.FURNACE_MINECART);
      });
      register(EntityType.GHAST, GhastRenderer::new);
      register(EntityType.GIANT, (p_174078_) -> {
         return new GiantMobRenderer(p_174078_, 6.0F);
      });
      register(EntityType.GLOW_ITEM_FRAME, ItemFrameRenderer::new);
      register(EntityType.GLOW_SQUID, (p_174076_) -> {
         return new GlowSquidRenderer(p_174076_, new SquidModel<>(p_174076_.bakeLayer(ModelLayers.GLOW_SQUID)));
      });
      ...
      register(EntityType.HOPPER_MINECART, (p_174074_) -> {
         return new MinecartRenderer<>(p_174074_, ModelLayers.HOPPER_MINECART);
      });
      ...
      register(EntityType.LLAMA, (p_174072_) -> {
         return new LlamaRenderer(p_174072_, ModelLayers.LLAMA);
      });
      ...
      register(EntityType.MINECART, (p_174070_) -> {
         return new MinecartRenderer<>(p_174070_, ModelLayers.MINECART);
      });
      register(EntityType.MOOSHROOM, MushroomCowRenderer::new);
      register(EntityType.MULE, (p_174068_) -> {
         return new ChestedHorseRenderer<>(p_174068_, 0.92F, ModelLayers.MULE);
      });
      ...
      register(EntityType.PIGLIN, (p_174066_) -> {
         return new PiglinRenderer(p_174066_, ModelLayers.PIGLIN, ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false);
      });
      register(EntityType.PIGLIN_BRUTE, (p_174064_) -> {
         return new PiglinRenderer(p_174064_, ModelLayers.PIGLIN_BRUTE, ModelLayers.PIGLIN_BRUTE_INNER_ARMOR, ModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, false);
      });
      ...
      register(EntityType.SKELETON_HORSE, (p_174062_) -> {
         return new UndeadHorseRenderer(p_174062_, ModelLayers.SKELETON_HORSE);
      });
      register(EntityType.SLIME, SlimeRenderer::new);
      register(EntityType.SMALL_FIREBALL, (p_174060_) -> {
      ...
      register(EntityType.SPAWNER_MINECART, (p_174058_) -> {
         return new MinecartRenderer<>(p_174058_, ModelLayers.SPAWNER_MINECART);
      });
      register(EntityType.SPECTRAL_ARROW, SpectralArrowRenderer::new);
      register(EntityType.SPIDER, SpiderRenderer::new);
      register(EntityType.SQUID, (p_174056_) -> {
         return new SquidRenderer<>(p_174056_, new SquidModel<>(p_174056_.bakeLayer(ModelLayers.SQUID)));
      });
      ...
      register(EntityType.TRADER_LLAMA, (p_174054_) -> {
         return new LlamaRenderer(p_174054_, ModelLayers.TRADER_LLAMA);
      });
      ...
      register(EntityType.ZOMBIE_HORSE, (p_234612_) -> {
         return new UndeadHorseRenderer(p_234612_, ModelLayers.ZOMBIE_HORSE);
      });
      register(EntityType.ZOMBIE_VILLAGER, ZombieVillagerRenderer::new);
      register(EntityType.ZOMBIFIED_PIGLIN, (p_234610_) -> {
         return new PiglinRenderer(p_234610_, ModelLayers.ZOMBIFIED_PIGLIN, ModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, ModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true);
      });
   }
}