...
public class BlockStatePredictionHandler implements AutoCloseable {
   ...
   public void retainKnownServerState(BlockPos p_233868_, BlockState p_233869_, LocalPlayer p_233870_) {
      this.serverVerifiedStates.compute(p_233868_.asLong(), (p_308282_, p_308283_) -> {
         return p_308283_ != null ? p_308283_.setSequence(this.currentSequenceNr) : new BlockStatePredictionHandler.ServerVerifiedState(this.currentSequenceNr, p_233869_, p_233870_.position());
      });
   }
