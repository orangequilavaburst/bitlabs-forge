...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerWidget {
   ...
   public void renderWidget(GuiGraphics p_282708_, int p_283242_, int p_282891_, float p_283683_) {
      ...
      if (this.renderBackground) {
         ...
         int i = 32;
         p_282708_.blit(Screen.BACKGROUND_LOCATION, this.getX(), this.getY(), (float)this.getRight(), (float)(this.getBottom() + (int)this.getScrollAmount()), this.width, this.height, 32, 32);
      ...
      if (this.renderBackground) {
         int j1 = 4;
         p_282708_.fillGradient(RenderType.guiOverlay(), this.getX(), this.getY(), this.getRight(), this.getY() + 4, -16777216, 0, 0);
         p_282708_.fillGradient(RenderType.guiOverlay(), this.getX(), this.getBottom() - 4, this.getRight(), this.getBottom(), 0, -16777216, 0);
      }
      ...
      if (k1 > 0) {
         ...
         p_282708_.fill(l1, this.getY(), l1 + 6, this.getBottom(), -16777216);
   ...
   public boolean mouseScrolled(double p_93416_, double p_93417_, double p_93418_, double p_298552_) {
      this.setScrollAmount(this.getScrollAmount() - p_298552_ * (double)this.itemHeight / 2.0D);
      return true;
   }
