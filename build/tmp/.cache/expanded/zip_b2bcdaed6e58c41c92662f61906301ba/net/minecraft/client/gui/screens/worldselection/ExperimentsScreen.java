...
public class ExperimentsScreen extends Screen {
   ...
   protected void init() {
      ...
      linearlayout.addChild((new MultiLineTextWidget(Component.translatable("selectWorld.experiments.info").withStyle(ChatFormatting.RED), this.font)).setMaxWidth(310), (p_296222_) -> {
         p_296222_.paddingBottom(15);
      });
      ...
      gridlayout$rowhelper.addChild(Button.builder(CommonComponents.GUI_DONE, (p_270336_) -> {
         this.onDone();
      }).build());
      gridlayout$rowhelper.addChild(Button.builder(CommonComponents.GUI_CANCEL, (p_274702_) -> {
         this.onClose();
      }).build());
   ...
   public void renderBackground(GuiGraphics p_297235_, int p_298951_, int p_298046_, float p_297474_) {
      super.renderBackground(p_297235_, p_298951_, p_298046_, p_297474_);
      p_297235_.setColor(0.125F, 0.125F, 0.125F, 1.0F);
      int i = 32;
      p_297235_.blit(BACKGROUND_LOCATION, 0, this.layout.getHeaderHeight(), 0.0F, 0.0F, this.width, this.height - this.layout.getHeaderHeight() - this.layout.getFooterHeight(), 32, 32);
      p_297235_.setColor(1.0F, 1.0F, 1.0F, 1.0F);
   }
}