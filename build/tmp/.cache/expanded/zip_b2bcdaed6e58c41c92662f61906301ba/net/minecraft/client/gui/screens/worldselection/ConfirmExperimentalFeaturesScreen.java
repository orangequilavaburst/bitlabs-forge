...
public class ConfirmExperimentalFeaturesScreen extends Screen {
   ...
   class DetailsScreen extends Screen {
      ...
      protected void init() {
         ...
         this.packList = this.addRenderableWidget(new ConfirmExperimentalFeaturesScreen.DetailsScreen.PackList(this.minecraft, ConfirmExperimentalFeaturesScreen.this.enabledPacks));
      }
      ...
      class PackList extends ObjectSelectionList<ConfirmExperimentalFeaturesScreen.DetailsScreen.PackListEntry> {
         public PackList(Minecraft p_249776_, Collection<Pack> p_251183_) {
            super(p_249776_, DetailsScreen.this.width, DetailsScreen.this.height - 96, 32, (9 + 2) * 3);
