...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
   ...
   private void blitNineSlicedSprite(TextureAtlasSprite p_300154_, GuiSpriteScaling.NineSlice p_300599_, int p_297486_, int p_298301_, int p_299602_, int p_299587_, int p_299827_) {
      ...
      if (p_299587_ == p_300599_.width() && p_299827_ == p_300599_.height()) {
         ...
         this.blitTiledSprite(p_300154_, p_297486_ + i, p_298301_, p_299602_, p_299587_ - j - i, p_299827_, i, 0, p_300599_.width() - j - i, p_300599_.height(), p_300599_.width(), p_300599_.height());
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), p_300599_.width() - j, 0, p_297486_ + p_299587_ - j, p_298301_, p_299602_, j, p_299827_);
         ...
         this.blitTiledSprite(p_300154_, p_297486_, p_298301_ + k, p_299602_, p_299587_, p_299827_ - l - k, 0, k, p_300599_.width(), p_300599_.height() - l - k, p_300599_.width(), p_300599_.height());
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), 0, p_300599_.height() - l, p_297486_, p_298301_ + p_299827_ - l, p_299602_, p_299587_, l);
      } else {
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), 0, 0, p_297486_, p_298301_, p_299602_, i, k);
         this.blitTiledSprite(p_300154_, p_297486_ + i, p_298301_, p_299602_, p_299587_ - j - i, k, i, 0, p_300599_.width() - j - i, k, p_300599_.width(), p_300599_.height());
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), p_300599_.width() - j, 0, p_297486_ + p_299587_ - j, p_298301_, p_299602_, j, k);
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), 0, p_300599_.height() - l, p_297486_, p_298301_ + p_299827_ - l, p_299602_, i, l);
         this.blitTiledSprite(p_300154_, p_297486_ + i, p_298301_ + p_299827_ - l, p_299602_, p_299587_ - j - i, l, i, p_300599_.height() - l, p_300599_.width() - j - i, l, p_300599_.width(), p_300599_.height());
         this.blitSprite(p_300154_, p_300599_.width(), p_300599_.height(), p_300599_.width() - j, p_300599_.height() - l, p_297486_ + p_299587_ - j, p_298301_ + p_299827_ - l, p_299602_, j, l);
         this.blitTiledSprite(p_300154_, p_297486_, p_298301_ + k, p_299602_, i, p_299827_ - l - k, 0, k, i, p_300599_.height() - l - k, p_300599_.width(), p_300599_.height());
         this.blitTiledSprite(p_300154_, p_297486_ + i, p_298301_ + k, p_299602_, p_299587_ - j - i, p_299827_ - l - k, i, k, p_300599_.width() - j - i, p_300599_.height() - l - k, p_300599_.width(), p_300599_.height());
         this.blitTiledSprite(p_300154_, p_297486_ + p_299587_ - j, p_298301_ + k, p_299602_, i, p_299827_ - l - k, p_300599_.width() - j, k, j, p_300599_.height() - l - k, p_300599_.width(), p_300599_.height());
      }
   }
   ...
   public void renderFakeItem(ItemStack p_309605_, int p_310104_, int p_309448_, int p_310674_) {
      this.renderItem((LivingEntity)null, this.minecraft.level, p_309605_, p_310104_, p_309448_, p_310674_);
   }
