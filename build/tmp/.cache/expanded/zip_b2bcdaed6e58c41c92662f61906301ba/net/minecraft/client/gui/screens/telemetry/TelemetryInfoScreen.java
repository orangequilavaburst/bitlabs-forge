...
public class TelemetryInfoScreen extends Screen {
   ...
   protected void init() {
      ...
      GridLayout gridlayout = this.twoButtonContainer(Button.builder(BUTTON_PRIVACY_STATEMENT, this::openPrivacyStatementLink).build(), Button.builder(BUTTON_GIVE_FEEDBACK, this::openFeedbackLink).build());
   ...
   private Layout createLowerSection() {
      ...
      linearlayout.addChild(this.twoButtonContainer(Button.builder(BUTTON_SHOW_DATA, this::openDataFolder).build(), Button.builder(CommonComponents.GUI_DONE, this::openLastScreen).build()));
      return linearlayout;
   }
