...
public class Main {
   ...
   public static void main(String[] p_129642_) {
      ...
      try {
         ...
         Minecraft.fillReport((Minecraft)null, (LanguageManager)null, s3, (Options)null, crashreport);
         Minecraft.crash((Minecraft)null, file1, crashreport);
         return;
      }
      ...
      try {
         ...
         Minecraft.fillReport(minecraft, (LanguageManager)null, gameconfig.game.launchVersion, (Options)null, crashreport1);
