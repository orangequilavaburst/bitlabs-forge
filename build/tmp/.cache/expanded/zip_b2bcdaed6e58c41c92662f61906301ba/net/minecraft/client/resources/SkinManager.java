...
public class SkinManager {
            ...
            return CompletableFuture.supplyAsync(() -> {
               ...
               if (property == null) {
                  ...
                  if (minecraftprofiletextures.signatureState() == SignatureState.INVALID) {
                     SkinManager.LOGGER.warn("Profile contained invalid signature for textures property (profile id: {})", (Object)p_298169_.profileId());
                  }

                  return minecraftprofiletextures;
               }
            }, Util.backgroundExecutor()).thenComposeAsync((p_308313_) -> {
               return SkinManager.this.registerTextures(p_298169_.profileId(), p_308313_);
            }, p_299732_);
         }
      });
   }
   ...
   CompletableFuture<PlayerSkin> registerTextures(UUID p_312099_, MinecraftProfileTextures p_313047_) {
      ...
      return CompletableFuture.allOf(completablefuture, completablefuture1, completablefuture2).thenApply((p_308309_) -> {
         return new PlayerSkin(completablefuture.join(), s, completablefuture1.join(), completablefuture2.join(), playerskin$model, p_313047_.signatureState() == SignatureState.SIGNED);
      });
   }
