...
public class AdvancementToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics p_281813_, ToastComponent p_282243_, long p_282604_) {
      DisplayInfo displayinfo = this.advancement.value().display().orElse((DisplayInfo)null);
      ...
      if (displayinfo != null) {
         ...
         if (list.size() == 1) {
            p_281813_.drawString(p_282243_.getMinecraft().font, displayinfo.getType().getDisplayName(), 30, 7, i | -16777216, false);
